...
namespace Portal_WebParts.ToplantiGirisiWP
{
    ...
    public partial class ToplantiGirisiWP : WebPart
    {
        ...
        private void ToplantiFormunuDoldur()
        {
            ...
            if (toplanti != null)
            {
                TitleLbl.Text = "Toplanti Düzenleme";
        ...
        private void GirisiAc()
        {
            if (ToplantiyaYetkiliMi())
            {
                ...
                {
                    MessageHelper.PublishMessage("Toplanti Silindi, e-posta gönderildi.", ProjeConstants.MESAJ_BASARILI, 2000);
        ...
        private void BilesenleriEkisizlestir()
        {
            ...
            MessageHelper.PublishMessage("Toplanti islemleri için yetkilendirilmediginizden dolayi islem yapamazsiniz.", ProjeConstants.MESAJ_BILGI, 2000);
        }
        ...
        private void BaslangicSaatiDDLDoldur()
        {
            ...
            if (string.IsNullOrEmpty(ToplantiYeriDDL.SelectedItem.Text))
            {
                ...
                ListItem li1 = new ListItem("Önce Toplanti Yeri Seçiniz...");
                ...
                (!string.IsNullOrEmpty(BaslangicTarihiTxt.Text)))
            {
                foreach (ListItem item in BasSaatDDL.Items)
                {
                    if (!string.IsNullOrEmpty(item.Value))
                    {
                        ...
                        {
                            if (kayitliToplanti.Id != ToplantiIdQS.ConvertToInt()) //toplanti düzenlemesi yapilan toplantinin saatlerini disable etmesin
                ...
                do
                {
                    ...
                    if (ToplantiYeriDDL.SelectedItem.Value.ConvertToInt() != ProjeConstants.PARAM_DIGER_INT)
                    {
                        if (!string.IsNullOrEmpty(BitisTarihiTxt.Text))
                        {
                            ...
                            {
                                if (!toplanti.Id.ToString().Equals(ToplantiIdQS)) //kendisi hariç toplantilar
                                {
                                    break;
                                }
                            }
        ...
        private void KaydetOnayPopupAc()
        {
            ...
            {
                KaydetMesajBasligiLbl.Text = "Toplanti baslangiç saati geçti.";
                KaydetMesajiLbl.Text = "Toplanti baslangiç saati geçti. Kayit islemini iptal edip saati degistirebilirsiniz. Degisiklik yapmadan kaydetmek istiyor musunuz?";
            }
            else
            {
        ...
        private void GuncelleOnayPopupAc()
        {
            ...
            {
                KaydetMesajBasligiLbl.Text = "Toplanti baslangiç saati geçti.";
                KaydetMesajiLbl.Text = "Toplanti baslangiç saati geçti. Güncelleme islemini iptal edip saati degistirebilirsiniz. Degisiklik yapmadan güncellemek istiyor musunuz?";
            }
            else
            {
                KaydetMesajBasligiLbl.Text = "Toplanti güncellenecek";
                KaydetMesajiLbl.Text = string.Empty;
        ...
        protected void GuncelleNowBtn_Click(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        ...
                        if (ToplantiDegistiMi(toplanti))
                        {
                            ...
                            if (guncellendiMi)
                            {
                                ...
                                tar5 = DateTime.Now;
                                MessageHelper.PublishMessage("Toplanti güncellendi, e-posta gönderildi.", ProjeConstants.MESAJ_BASARILI, 2000);
                                tar6 = DateTime.Now;
                            ...
                            {
                                MessageHelper.PublishMessage("Toplanti güncellenemedi", ProjeConstants.MESAJ_HATA, 5000);
                        ...
                        {
                            RedirectToPage(ProjeConstants.PAGE_TOPLANTI_LIST + "?SecilenToplantiId=" + toplanti.Id);
                            MessageHelper.PublishMessage("Toplantida henüz degisiklik yapmadiniz.", ProjeConstants.MESAJ_BILGI, 2000);
                        }
                    }
                }
            }
            ...
            {
                ExceptionHelper exhelper = new ExceptionHelper(ex);
                exhelper.Exceptions.Add(new Exception("Toplanti güncellenemedi."));
                exhelper.PublishException();
            }
        ...
        private void ToplantiSilPopupAc(object sender)
        {
            ...
            SilMesajiLbl.Text = "Toplantiya ait tüm bilgiler silinecek ve toplanti katilimcilarina iptal e-postasi gönderilecektir. </br>Silmek istediginizden eminmisiniz?";
        ...
        private List<KatilimciListItem> GetDataList()
        {
            ...
            if (dataTable != null)
            {
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    katilimciItem.Cikar = "<a href='#' class='btn btn-outline-danger' onclick=KatilimciCikarBtnClick(" + katilimciId + ")>Çikar</a>";

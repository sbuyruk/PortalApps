...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OlayListesiWP.ascx.cs" Inherits="Portal_WebParts.OlayListesiWP.OlayListesiWP" %>
<style>
    .box {
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="box">
                        <marquee height="200" width="100%" behavior="scroll" direction="up" scrollamount="2" onmouseover="this.stop();" onmouseout="this.start();">
                            <ul id="OlayUl" runat="server">
                            </ul>
                        </marquee>
                    </div>

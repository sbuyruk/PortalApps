...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ToplantiParametreGirisiWP.ascx.cs" Inherits="Portal_WebParts.ToplantiParametreGirisiWP.ToplantiParametreGirisiWP" %>
...
<div class="container">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-danger font-weight-bold mb-1" ID="TitleLbl" runat="server" Text="Toplantı Parametreleri"></asp:Label>
        ...
        <div class="card-body">
            <div class="form-group col-3">
                <asp:DropDownList ID="ToplantiGrupDDL" CssClass="form-control" runat="server" Height="34px" OnSelectedIndexChanged="ToplantiGrupDDL_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
            </div>
            <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="ToplantiGrupDDL" EventName="SelectedIndexChanged" />
                </Triggers>
            </asp:UpdatePanel>
        </div>

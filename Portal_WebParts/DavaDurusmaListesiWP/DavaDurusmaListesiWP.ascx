...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DavaDurusmaListesiWP.ascx.cs" Inherits="Portal_WebParts.DavaDurusmaListesiWP.DavaDurusmaListesiWP" %>
<%-- Yeni yeri Portal_webparts --%>
<div class="col-xl">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-danger fw-bold mb-1" ID="TitleLbl" runat="server" Text="Dava Duruşma Listesi"></asp:Label>

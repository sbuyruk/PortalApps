...
namespace Portal_WebParts.KutlamaMoveWP {
    ...
    public partial class KutlamaMoveWP {
        ...
        private global::System.Web.UI.HtmlControls.HtmlGenericControl @__BuildControlYokDiv() {
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n                    Bugün dogan veya evlilik yildönümü olan personelimiz bulunm" +
                        "amaktadir.\r\n                "));
            return @__ctrl;
        }
        ...
        private void @__Render__control1(System.Web.UI.HtmlTextWriter @__w, System.Web.UI.Control parameterContainer) {
            @__w.Write(@"
<style>
    /*Arka arkaya açilan popup pencerelerde modal backdrop farkli gelsin diye*/
...
<script type=""text/javascript"">
    ...
    function OpenKutlamaPopup(clicked, opener) {
        ...
        // ilk açilista checkbox  checked= true gelsin
        document.getElementById('");
                         @__w.Write( KutlamayiOkudumChk.ClientID);

            @__w.Write(@"').checked = true;

        //cookie islemleri, gösterildi olarak cookie at
        var aCookie = ""KutlamaGosterildi"";
        var kutlamaGosterildi = cookieGosterildiMi(aCookie);
        if (!kutlamaGosterildi || clicked) {
            if (clicked || kutlamaGosterildi) { // tiklandiysa veya daha önce gösterildiyse okudumDiv görünmesin

    ...
    public class UnvanTanim : ParentClass
    {
        ...
        public override int Save()
        {
            try
            {
                ...
                GenericEntity<UnvanTanim> genericEntity = new GenericEntity<UnvanTanim>(ProjeConstants.SQL_INSERT);
                ...
                if (id > 0 && ProjeConstants.IKYS_SAVE_LOG)
                {
                    ...
                    olayKayit.GirisOlayKaydet(this, ProjeConstants.IKYS, ProjeConstants.IKYS_UNVANTANIM);
                }
                this.Id = id;
                return id;
            }
        ...
        public override bool Update()
        {
            ...
            try
            {
                UnvanTanim item = Select<UnvanTanim>(Id);
                if (Id != 0)
                {
                    GenericEntity<UnvanTanim> genericEntity = new GenericEntity<UnvanTanim>(ProjeConstants.SQL_UPDATE);
                ...
                {
                    OlayKayit olayKayit = new OlayKayit();
                    olayKayit.GuncellemeOlayKaydet(this, item, ProjeConstants.IKYS, ProjeConstants.IKYS_UNVANTANIM);
                }
            }
            catch (Exception)
            {
        ...
        public override bool Delete()
        {
            try
            {
                ...
                if (Id != 0)
                {
                    GenericEntity<UnvanTanim> genericEntity = new GenericEntity<UnvanTanim>(ProjeConstants.SQL_DELETE);
                    string sqlString = genericEntity.GetQuery(this);
                    ...
                    {
                        OlayKayit olayKayit = new OlayKayit();
                        olayKayit.SilmeOlayKaydet(item, ProjeConstants.IKYS, ProjeConstants.IKYS_UNVANTANIM);
                    }
                    return isDeleted;
                }
                else

    ...
    public class EgitimSeviyesi : ParentClass
    {
        ...
        public override int Save()
        {
            try
            {
                ...
                GenericEntity<EgitimSeviyesi> genericEntity = new GenericEntity<EgitimSeviyesi>(ProjeConstants.SQL_INSERT);
                ...
                if (id > 0 && ProjeConstants.IKYS_SAVE_LOG)
                {
                    ...
                    olayKayit.GirisOlayKaydet(this, ProjeConstants.IKYS, ProjeConstants.IKYS_EGITIMSEVIYESI);
                }
                this.Id = id;
                return id;
            }
        ...
        public override bool Update()
        {
            ...
            try
            {
                EgitimSeviyesi item = Select<EgitimSeviyesi>(Id);
                if (Id != 0)
                {
                    GenericEntity<EgitimSeviyesi> genericEntity = new GenericEntity<EgitimSeviyesi>(ProjeConstants.SQL_UPDATE);
                ...
                {
                    OlayKayit olayKayit = new OlayKayit();
                    olayKayit.GuncellemeOlayKaydet(this, item, ProjeConstants.IKYS, ProjeConstants.IKYS_EGITIMSEVIYESI);
                }
            }
            catch (Exception)
            {
        ...
        public override bool Delete()
        {
            try
            {
                ...
                if (Id != 0)
                {
                    GenericEntity<EgitimSeviyesi> genericEntity = new GenericEntity<EgitimSeviyesi>(ProjeConstants.SQL_DELETE);
                    string sqlString = genericEntity.GetQuery(this);
                    ...
                    {
                        OlayKayit olayKayit = new OlayKayit();
                        olayKayit.SilmeOlayKaydet(item, ProjeConstants.IKYS, ProjeConstants.IKYS_EGITIMSEVIYESI);
                    }
                    return isDeleted;
                }
                else

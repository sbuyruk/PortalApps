...
namespace MYS_WebParts.MalzemeKategoriListesiWP
{
    ...
    public partial class MalzemeKategoriListesiWP : WebPart
    {
        ...
        public MalzemeKategoriListesiWP()
        {
        }
        ...
        private string CreateJsString(string jsonData)
        {
            ...
            string tablestr = @"   
                                ...
                                columns: [
                                    ...
                                    { field: 'Adi', headerText: 'Malzeme Kategorisi', sortable:true,filter: true},

                                    { field: 'KisaAdi', headerText: 'Kısaltması',sortable:true,filter: true },
                                    { field: 'MalzemeKategoriId',headerClass:'darSutun', content: function (rowData)
                                    	{
                                            return $('<a href='+'MalzemeKategoriGirisi.aspx?DestinationApp=MKD&MalzemeKategoriId='+rowData.MalzemeKategoriId +  ' class=\'btn btn-outline-primary \'>Düzenle</a>')
                                    	}
                                    }
        ...
        protected void BackBtn_Click(object sender, EventArgs e)
        {
            ...
            string newUrl = currentUrl.Substring(0, currentUrl.LastIndexOf("/")) + "/" + ProjeConstants.PAGE_MALZEMEKATEGORI_LIST;

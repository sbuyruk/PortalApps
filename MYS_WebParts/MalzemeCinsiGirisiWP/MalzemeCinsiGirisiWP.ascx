...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MalzemeCinsiGirisiWP.ascx.cs" Inherits="MYS_WebParts.MalzemeCinsiGirisiWP.MalzemeCinsiGirisiWP" %>
        ...
        <ContentTemplate>
            <div class="card">
                <div class="card-header" id="CardHeader" runat="server">
                    ...
                    <h3 class="mb-2">
                        <asp:Label CssClass="col-form-label  btn-outline-success mb-1" ID="TitleLbl" runat="server" Text="Malzeme Cinsi Girişi"></asp:Label>
                        <asp:Label CssClass="col-form-label text-white" ID="IdLbl" runat="server"></asp:Label>
                        <asp:Label CssClass="col-form-label " ID="CinsiLbl" runat="server"></asp:Label>
                ...
                <div class="card-body alert-secondary" id="MainCardDiv" runat="server">
                    <div class="form-group m-0">
                        <label class="col-form-label" for="KategoriDDL">Kategorisi</label>
                        <%--<asp:RequiredFieldValidator runat="server" ControlToValidate="KategoriDDL" ForeColor="Red" ErrorMessage="Zorunlu Alan"> </asp:RequiredFieldValidator>--%>
                        <asp:DropDownList ID="KategoriDDL" runat="server" class="form-control " />
                    </div>
                    <div class="form-group m-0">
                        <label class="col-form-label" for="AdiTxt">Cinsi</label>
                    ...
                    <div class="form-group m-0">
                        <label class="col-form-label" for="KisaAdiTxt">Cinsi (Kısa)</label>
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="AdiTxt" ForeColor="Red" ErrorMessage="Zorunlu Alan"> </asp:RequiredFieldValidator>

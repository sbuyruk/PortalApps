...
<script>
    ...
    function SiralamayiKaydet() {
        ...
        document.getElementById('<%= paramProtokolArray.ClientID%>').value = tableData;
...
<div class="container ">
    ...
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-primary font-weight-bold mb-1" ID="TitleLbl" runat="server" Text="Protokol Sırası"></asp:Label>
        ...
        <div style="display:none">
            <input id="paramProtokolArray"  runat="server" type="text" />

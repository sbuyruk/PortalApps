...
namespace IKYS_WebParts.GorevOnayListesiWP {
    ...
    public partial class GorevOnayListesiWP {
        ...
        private global::System.Web.UI.WebControls.LinkButton @__BuildControlRaporAlBtn() {
            ...
            @__ctrl.Text = "Seçilen Görevler Için Rapor Al";
    ...
    function AddRemoveSecimListesi(aniObjesiId, chkbox) {
        ...
        document.getElementById('");
            ...
            @__w.Write("\').value;\r\n        var idList = idString.split(\',\');\r\n        idArray = [];\r\n    " +
                    ...
                    "Complete\': function (settings, json) {//tablo yüklendiginde\r\n                var" +
                    " api = this.api();\r\n                var row = api.row(function (idx, data, node)" +
                    " { //secilen kayita gider\r\n                    return data[\'Secildi\'] == true;\r\n" +
                    "                });\r\n                if (row.length > 0) {\r\n                    " +
                    "row.select()\r\n                        .show()\r\n                        .draw(fal" +
                    "se);\r\n                }\r\n            },\r\n            data: myjsons,\r\n           " +
                    " columns: [\r\n                { data: \"SecChk\" },\r\n                { data: \"AdiSo" +
                    ...
                    "              columns: \':visible\'\r\n                    }\r\n                },\r\n  " +
                    "              , \'pageLength\', \"colvis\"\r\n            ],\r\n\r\n        });\r\n\r\n       " +
                    " ArrayDoldur();\r\n        // Check All butonuna tiklaninca\r\n        table = $(\'#C" +
                    "ustomDataTable\').DataTable();\r\n        $(\'#checkAll\').on(\'click\', function () {\r" +
                    "\n            var isChecked = $(this).is(\':checked\');\r\n            \r\n            " +
                    "// Sadece aktif sayfadaki checkbox\'lari seç\r\n            table.rows({ page: \'cur" +
                    "rent\' }).nodes().to$().find(\'input[type=\"checkbox\"]\').each(function () {\r\n      " +
                    "          if ($(this).prop(\'checked\') !== isChecked) {\r\n                    $(th" +
                    "is).click();\r\n                }\r\n            });\r\n        });\r\n        //tabloda" +
                    " sayfalar arasi geçiste açilan sayfadaki tüm checkbox\'lar checkli ise checkAll\'i" +

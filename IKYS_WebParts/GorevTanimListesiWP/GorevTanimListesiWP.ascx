...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GorevTanimListesiWP.ascx.cs" Inherits="IKYS_WebParts.GorevTanimListesiWP.GorevTanimListesiWP" %>
...
<div class="container">
    <div class="card shadow">
        <div class="card-header ">
            ...
            <h3 class="mb-1">
                <asp:Label CssClass="col-form-label  btn-outline-primary" runat="server" Text="TSKGV Kadro-Görev Listesi"></asp:Label>
            </h3>

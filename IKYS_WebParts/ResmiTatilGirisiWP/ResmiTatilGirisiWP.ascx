...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <asp:LinkButton CssClass="btn btn-outline-secondary float-right" ID="ResmiTatilListesiBtn" runat="server" Text="Resmi Tatiller" CausesValidation="false" OnClick="ResmiTatilListesiBtn_Click" />

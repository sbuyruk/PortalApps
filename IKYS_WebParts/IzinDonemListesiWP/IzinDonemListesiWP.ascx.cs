                    ...
                    DuzenleBtn.Click += delegate
                    {
                        try
                        {
                            ...
                            if (izinDonemId > 0)
                            {
                                ...
                                ModalSubTitleLbl.Text = izinDonemiStr + " Izin Dönemi";
        ...
        protected void UpdateNowBtn_Click(object sender, EventArgs e)
        {
            ...
            if (izinDonemi != null)
            {
                try
                {
                    ...
                    {
                        MessageHelper.PublishMessage("Kayit Yapilamadi. Izin Hakki, Kullanilan Izin ve Kalan Izin degerlerine lütfen tamsayi giriniz", ProjeConstants.MESAJ_HATA);
                    }
                }
                catch (Exception)
                {

                    MessageHelper.PublishMessage("Izin Hakkii Kullanilan Izin ve Kalan Izin bilgilerine lütfen tamsayi giriniz", ProjeConstants.MESAJ_HATA);
                }
            ...
            try
            {
                ...
                if (izinDonemi != null)
                {
                    ...
                    if (ib != null)
                    {
                        ...
                        if (bittar < bastar)
                        {
                            Exception ex = new Exception("Ise Basladigindan bu yana olan tüm dönemler zaten tanimli. Yeni izin dönemi eklenemez.");
                            throw (ex);
            ...
            try
            {
                ...
                if (validated)
                {
                    ...
                    if (ib != null)
                    {
                        ...
                        {
                            Exception ex = new Exception("Izin Dönemi sonu itibari ile dönemler arasi çakisma var");
                            throw (ex);
                        }
                    }

...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BirimListesiWP.ascx.cs" Inherits="IKYS_WebParts.BirimListesiWP.BirimListesiWP" %>
...
<div class="container">
    <div class="card shadow">
        <div class="card-header ">
            ...
            <h3 class="mb-1">
                <asp:Label CssClass="col-form-label  btn-outline-primary" runat="server" Text="TSKGV Birimleri Listesi"></asp:Label>
            </h3>
        </div>
        <div class="card-body">
            <div class="card-body">

    ...
    public partial class IzinTalepGirisWP : WebPart
    {
        ...
        private void BirinciSatir(int siraNo, string izinTipi, string basTar, string bitTar, string sure, int onayDurumuId, string onayDurumu, string aciklama,int izinDonemId,int izinTalepId)
        {
                ...
                || onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_DILEKCEBEKLIYOR))
            {
                ...
                SilBtn1.ToolTip = "Talebiniz Islem görmeden önce silebilirsiniz.";
            }
            else if (onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_KONTROLEDILDI_INT))
            {
                ...
                YazdirLnk1.ToolTip = "Talebiniz yazdirmak için dügmeye basiniz.";
        ...
        private void IkinciSatir(int siraNo, string izinTipi, string basTar, string bitTar, string sure, int onayDurumuId, string onayDurumu, string aciklama, int izinDonemId, int izinTalepId)
        {
                ...
                || onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_DILEKCEBEKLIYOR))
            {
                ...
                SilBtn2.ToolTip = "Talebiniz Islem görmeden önce silebilirsiniz.";
            }
            else if (onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_KONTROLEDILDI_INT))
            {
                ...
                YazdirLnk2.ToolTip = "Talebiniz yazdirmak için dügmeye basiniz.";
        ...
        private void UcuncuSatir(int siraNo, string izinTipi, string basTar, string bitTar, string sure, int onayDurumuId, string onayDurumu, string aciklama, int izinDonemId, int izinTalepId)
        {
                ...
                || onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_DILEKCEBEKLIYOR))
            {
                ...
                SilBtn3.ToolTip = "Talebiniz Islem görmeden önce silebilirsiniz.";
            }
            else if (onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_KONTROLEDILDI_INT))
            {
                ...
                YazdirLnk3.ToolTip = "Talebiniz yazdirmak için dügmeye basiniz.";
        ...
        private void DorduncuSatir(int siraNo, string izinTipi, string basTar, string bitTar, string sure, int onayDurumuId, string onayDurumu, string aciklama, int izinDonemId, int izinTalepId)
        {
                ...
                || onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_DILEKCEBEKLIYOR))
            {
                ...
                SilBtn4.ToolTip = "Talebiniz Islem görmeden önce silebilirsiniz.";
            }
            else if (onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_KONTROLEDILDI_INT))
            {
                ...
                YazdirLnk4.ToolTip = "Talebiniz yazdirmak için dügmeye basiniz.";
        ...
        private void BesinciSatir(int siraNo, string izinTipi, string basTar, string bitTar, string sure, int onayDurumuId, string onayDurumu, string aciklama, int izinDonemId, int izinTalepId)
        {
                ...
                || onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_DILEKCEBEKLIYOR))
            {
                ...
                SilBtn5.ToolTip = "Talebiniz Islem görmeden önce silebilirsiniz.";
            }
            else if (onayDurumuId.Equals(ProjeConstants.PER_IZINTALEBI_KONTROLEDILDI_INT))
            {
                ...
                YazdirLnk5.ToolTip = "Talebiniz yazdirmak için dügmeye basiniz.";
        ...
        private void SetLayoutByIzinTipi()
        {
            ...
            if (IzinTanimIdQS.ConvertToInt() == (ProjeConstants.IZINTIPI_MAZERET_INT)) //(IzinTanimDDL.SelectedItem.Value.ConvertToInt() == (ProjeConstants.IZINTIPI_MAZERET_INT))
            {
                ...
                //KalanIzinKontrolIslemleri();
                KullanilmayanLbl.Text = "Not: Kullanilmayan Mazeret izinleri müteakip yila aktarilmaz.";
            }
            ...
            else if (IzinTanimIdQS.ConvertToInt() == (ProjeConstants.IZINTIPI_SUTIZNI_INT))
            {
                ...
                AciklamaTxt.Text = "Süt Izni (Günde 1 Buçuk saat)";
                KullanilmayanLbl.Text = "Not: Süt Izni girdiginiz saatten baslayarak günlük 1 buçuk saat olarak uygulanir.";
        ...
        /// Girilen Izin baslangiç tarihine bakarak izin dönemi baslangicini bulur,
        /// Buldugu döneme ait IzinDonem_Table'da kayit yoksa, ekler
        /// </summary>
        /// <returns></returns>
        ...
        private bool IzinTalebiGuncelle()
        {
            ...
            try
            {
                ...
                if (izinTalep != null)
                {
                    ...
                    else if (izinTalep.IzinTipi != ProjeConstants.IZINTIPI_MAZERET_INT) //Mazeret hariç digr izinler
                    {
                ...
                if (personel != null)
                {
                    ...
                    if (isValid)
                    {
                        bool devamEdenIzinTalebiVarMi = IslemiDevamEdenIzinTalebiVarMi(personel.Id);// SB 13/09/2019 devam eden izin talebi kontrolu eklendi
                                                                                                    //bool cakismaVarMi = BuTarihteCakisanIzinTalebiVarMi(personel.Id);//  SB 13/09/2019 devam eden izin talebi kontrolu eklendiginden çalisma kontrolüne gerek kalmadi
                        if (devamEdenIzinTalebiVarMi)//if (cakismaVarMi)
                        {
                            //MessageHelper.PublishMessage("Bu tarihle çakisan bir izin talebiniz zaten var."+System.Environment.NewLine+
                            //    "Kisisel sayfanizdan Izin taleplerinizi görebilirsiniz.", ProjeConstants.MESAJ_HATA,15000);
                            MessageHelper.PublishMessage("Islemi devam eden bir izin talebiniz zaten var." + System.Environment.NewLine +
                               "Yeni bir izin talep etmeden önce var olan izin talebinizin sonuçlanmasi gerekmektedir.", ProjeConstants.MESAJ_HATA, 15000);
                            SaveBtn.Visible = false;
                            UpdateBtn.Visible = false;
                    ...
                    {
                        MessageHelper.PublishMessage("Lütfen Kalan Izin sürenizi Kontrol Ediniz.", ProjeConstants.MESAJ_HATA);
                    }
                }
                else
                {
        ...
        protected void UpdateBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isSaved)
                    MessageHelper.PublishMessage("Izin Talebi Güncellendi", ProjeConstants.MESAJ_BASARILI, 2000);

            }
            catch (Exception exception)
            {
                ExceptionHelper exceptionHelper = new ExceptionHelper(exception);
                Exception exceptionInfo = new Exception("Izin Talebi Güncellenemdi");
                exceptionHelper.Exceptions.Add(exceptionInfo);
                exceptionHelper.PublishException();
            }
        ...
        private bool KalanIzinKontrolIslemleri()
        {
            ...
            {
                MessageHelper.PublishMessage("Personel IzinBaslama Tarihi Geçersiz. Izin talebi olusturulamaz.", ProjeConstants.MESAJ_HATA);
                return false;
            }
            int izinTipi = IzinTanimDDL.SelectedItem.Value.ConvertToInt();
            ...
            if (devamEdenIzinTalebiVarMi)//if (cakismaVarMi)
            {
                ...
                //    "Kisisel sayfanizdan Izin taleplerinizi görebilirsiniz.", ProjeConstants.MESAJ_HATA,15000);
                MessageHelper.PublishMessage("Islemi devam eden bir izin talebiniz zaten var." + System.Environment.NewLine +
                   "Yeni bir izin talep etmeden önce var olan izin talebinizin sonuçlanmasi gerekmektedir.", ProjeConstants.MESAJ_HATA, 5000);
                return false;
            }
            ...
            if (izinTipi == ProjeConstants.IZINTIPI_SUTIZNI_INT)
            {
                ...
                if (aile != null)
                {
                    ...
                    {
                        UyariLbl.Text = "Yalnizca bir yasini doldurmamis çocugu olan personel için süt izni girilebilir. ";
                        return false;
                    }
                }
                else
            ...
            else if (izinTipi != ProjeConstants.IZINTIPI_UCRETLI_INT && izinTipi != ProjeConstants.IZINTIPI_MAZERET_INT) // bu iki izin tipi disindaki izinler için kontrol yapmasin
            {
                IzinSuresiLbl.Text = string.Empty;
                KullanilanIzinLbl.Text = string.Empty;
                KalanIzinLbl.Text = string.Empty;
            ...
            else
            {
                ...
                if (izinTipi == ProjeConstants.IZINTIPI_MAZERET_INT)
                {
                    ...
                    KullanilanIzinLbl.Text = izinDonemi.BaslangicTarihi.ConvertToDatetimeEmptyIfNull() + "-" + izinDonemi.BitisTarihi.ConvertToDatetimeEmptyIfNull()
                        + " Izin döneminde, " + izinDonemi.IzinHakki.ConvertToTimeSpanReturnInHHmm() + " " + ProjeConstants.IZINTIPI_MAZERET + " izninizden kullandiginiz izin süresi "
                    ...
                    IzinSuresiLbl.Text = "Kullanmak istediginiz izin süresi: " + sureStr.ConvertToTimeSpanReturnInHHmm() ;
                    ...
                    if (kalanIzinTs <= sifirTs)
                    {
                        ...
                        UyariLbl.Text = " Mazeret izni kullanabilmeniz için 'Yillik Ücretli Izninizden Mazeret Iznine Mahsup' dilekçenizi onaylatarak Personel Kismina teslim etmeniz gerekmektedir.";
                    ...
                    else if (sonuctaKalanIzinTs < sifirTs)
                    {
                        ...
                        UyariLbl.Text = "Daha fazla izin talebinde bulunmak istiyorsaniz lütfen 'Yillik Ücretli Izninizden Mazeret Iznine Mahsup' dilekçenizi onaylatarak Personel Kismina teslim etmeniz gerekmektedir.";
                ...
                {
                    KullanilanIzinLbl.Text = izinDonemi.BaslangicTarihi.ConvertToDatetimeEmptyIfNull() + "-" + izinDonemi.BitisTarihi.ConvertToDatetimeEmptyIfNull() 
                        + " Izin döneminde, " + izinDonemi.IzinHakki.ConvertToInt() + " " + izinDonemi.Birim + " " + ProjeConstants.IZINTIPI_UCRETLI + " izninizden kullandiginiz izin süresi : "
                    ...
                    if (kalanIzinInt < 0)
                    {
                        if (gecmisDonemlerdenKalanIzin > 0)
                        {
                            ...
                            {
                                KullanilanIzinLbl.Text = izinDonemi.BaslangicTarihi.ConvertToDatetimeEmptyIfNull() + "-" + izinDonemi.BitisTarihi.ConvertToDatetimeEmptyIfNull()
                                   + " Izin dönemine ait izninizin tamamini kullandiniz. Ilave olarak geçmis dönemleden kalan izin hakkinizdan karsilanan " + Math.Abs(kalanIzinInt) + " gün ile birlikte, bu izin döneminde kullandiginiz izin toplami "
                                   + izinDonemi.KullanilanIzin.ConvertToInt() + " " + izinDonemi.Birim + "dür. " + System.Environment.NewLine;

                                GecmisDonemlerdenKalanIznLbl.Text = " Geçmis dönemlerden kalan <strong>" + gecmisDonemlerdenKalanIzin + "</strong> gün izninizin <strong>" + Math.Abs(kalanIzinInt) + "</strong> gününü kullandiniz.";
                            }
                            else
                            {
                                KullanilanIzinLbl.Text = izinDonemi.BaslangicTarihi.ConvertToDatetimeEmptyIfNull() + "-" + izinDonemi.BitisTarihi.ConvertToDatetimeEmptyIfNull()
                                   + " Izin dönemine ait izninizin tamamini kullandiniz. Ilave olarak geçmis dönemleden kalan izin hakkinizdan karsilanan " + gecmisDonemlerdenKalanIzin + " gün ve fazladan kullandiginiz "
                                   + (Math.Abs(kalanIzinInt)- gecmisDonemlerdenKalanIzin) + "gün ile birlikte, bu izin döneminde kullandiginiz izin toplami "
                                   + izinDonemi.KullanilanIzin.ConvertToInt() + " gündür. " + System.Environment.NewLine;
                                
                                GecmisDonemlerdenKalanIznLbl.Text = " Geçmis dönemlerden kalan <strong>" + gecmisDonemlerdenKalanIzin + "</strong> gün izninizi kullandiniz.";
                            }
                        }
                        else
                        {
                            KullanilanIzinLbl.Text = izinDonemi.BaslangicTarihi.ConvertToDatetimeEmptyIfNull() + "-" + izinDonemi.BitisTarihi.ConvertToDatetimeEmptyIfNull()
                                  + " Izin dönemine ait izninizin tamamini kullandiniz. Ilave olarak fazladan kullandiginiz "
                                  + Math.Abs(kalanIzinInt)  + "gün ile birlikte, bu izin döneminde kullandiginiz izin toplami "
                                  + izinDonemi.KullanilanIzin.ConvertToInt() + " gündür. " + System.Environment.NewLine;
                            
                            GecmisDonemlerdenKalanIznLbl.Text = " Geçmis Dönemlerden kalan kullanilmamis izniniz bulunmamaktadir.";
                        } 
                    }
                    else
                    {
                        if (gecmisDonemlerdenKalanIzin > 0)
                        {
                                ...
                                GecmisDonemlerdenKalanIznLbl.Text = " Geçmis dönemlerden kalan <strong>" + gecmisDonemlerdenKalanIzin + "</strong> gün izniniz bulunmaktadir.";
                         }
                        else if (gecmisDonemlerdenKalanIzin == 0)
                            GecmisDonemlerdenKalanIznLbl.Text = " Geçmis Dönemlerden kalan kullanilmamis izniniz bulunmamaktadir.";
                        else
                        {
                            GecmisDonemlerdenKalanIznLbl.Text = " Bu yilki izninizden  <strong>" + Math.Abs(gecmisDonemlerdenKalanIzin)+ "</strong> gün geçmis dönemlerde kullandiniz.";
                        }
                    }
                    ...
                    string sureStr = IKYSOrtak.IzinSuresiHesapla(izinTipi, baslangicTarihi, bitisTarihi);
                    IzinSuresiLbl.Text = "Kullanmak istediginiz izin süresi: " + sureStr + " "+ izinDonemi.Birim;
                    ...
                    if (kalanIzinToplami <= 0)
                    {
                        ...
                        UyariLbl.Text = " Izin talebinde bulunmadan önce Gelecek Dönem Yillik Ücretli Izninizden mahsup edilmesi için dilekçenizi onaylatarak Personel Kismina teslim etmeniz gerekmektedir.";
                        IzinDonemIdQS = izinDonemi.Id.ToString();
                    ...
                    if (kalanIzinToplami > 0 && sonuctaKalanIzinInt < 0)
                    {
                        ...
                        UyariLbl.Text = " Lütfen izin bitis tarihini buna göre seçerek tekrar talebinizi gönderiniz.";
        ...
        private bool ValidateInputs(int izinTipi)
        {
            ...
            {
                isValidated = false;
                MessageHelper.PublishMessage("Lütfen izin baslangiç tarihini giriniz.", ProjeConstants.MESAJ_HATA, 2000);
            }
            else if (izinTipi != ProjeConstants.IZINTIPI_MAZERET_INT)
            {
                ...
                {
                    isValidated = false;
                    MessageHelper.PublishMessage("Lütfen izin bitis tarihini giriniz.", ProjeConstants.MESAJ_HATA, 2000);
            ...
            else if (izinTipi == ProjeConstants.IZINTIPI_MAZERET_INT)
            {
                ...
                {
                    isValidated = false;
                    MessageHelper.PublishMessage("Lütfen izin baslama ve bitis saatlerini giriniz.", ProjeConstants.MESAJ_HATA, 2000);
                }
            }
            else if (izinTipi == ProjeConstants.IZINTIPI_SUTIZNI_INT)
            {
                ...
                {
                    isValidated = false;
                    MessageHelper.PublishMessage("Lütfen izin baslama saatini giriniz.", ProjeConstants.MESAJ_HATA, 2000);
                }
            }
            return isValidated;
        }
        ...
        protected void MazereteMahsupDilekceBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageHelper.PublishMessage("Izin Dönemi Bulunamadi.", ProjeConstants.MESAJ_HATA);
            }
        }
        ...
        protected void SilBtn1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageHelper.PublishMessage("Izin talebi bulunamadi, talebiniz zaten silinmis olabilir. Lütfen kontolediniz.", ProjeConstants.MESAJ_BILGI);
            }

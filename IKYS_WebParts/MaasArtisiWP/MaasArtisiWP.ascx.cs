...
namespace IKYS_WebParts.MaasArtisiWP
{
    ...
    public partial class MaasArtisiWP : WebPart
    {
        ...
        private void KaydetModalAc()
        {
            ...
            MessageTextLbl.Text = BaslangicTarihiTxt.Text + " ile " + BitisTarihiTxt.Text + " arasinda geçerli olacak ve %" +ArtisYuzdesiTxt.Text+" artis yapilacak sekilde maas tablolari kaydedilsin mi?";
        ...
        private void SilModalAc()
        {
            ...
            ucretTanim = list[0];
            MessageTitleLbl.Text = "Son Maas Artisi Ve Bu artisa göre yapilan Maas Listesi Silinecek";
            MessageTextLbl.Text = ucretTanim.BaslangicTarihi.ConvertToDatetimeEmptyIfNull() + " ile " + ucretTanim.BitisTarihi.ConvertToDatetimeEmptyIfNull() + " arasinda geçerli olan artis silinsin mi?";

...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BagisciListesiWP.ascx.cs" Inherits="MTS_WebParts.BagisciListesiWP.BagisciListesiWP" %>
...
<div class="container ">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-1">
                <asp:Label ID="TitleLbl" runat="server" CssClass="col-form-label text-danger font-weight-bold mb-1" >Bağışçı Listesi<sup>1,2</sup></asp:Label>

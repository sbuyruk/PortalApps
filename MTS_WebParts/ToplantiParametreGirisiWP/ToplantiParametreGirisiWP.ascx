...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ToplantiParametreGirisiWP.ascx.cs" Inherits="MTS_WebParts.ToplantiParametreGirisiWP.ToplantiParametreGirisiWP" %>
<script>

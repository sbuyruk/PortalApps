...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FaaliyetKartiWP.ascx.cs" Inherits="MTS_WebParts.FaaliyetKartiWP.FaaliyetKartiWP" %>
...
<div class="container ">
    <div class="card shadow">
        <div class="card-header" id="CardHeader" runat="server">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-danger fw-bold mb-1" ID="TitleLbl" runat="server" Text="Faaliyet Kartı"></asp:Label>
        ...
        <div class="card-body" id="MainCardDiv" runat="server">
            <div class="table">
                <asp:Table ID="FaaliyetKartiBilgileriTable" runat="server" CssClass="table table-sm table-hover table-striped table-bordered" BorderStyle="Solid">
                    <asp:TableHeaderRow>
        ...
        <div class="card-footer">
            <asp:LinkButton ID="FaaliyeteGitBtn" CssClass="btn btn-outline-secondary" runat="server" Text="Faaliyete Git" OnClick="FaaliyeteGitBtn_Click"></asp:LinkButton>

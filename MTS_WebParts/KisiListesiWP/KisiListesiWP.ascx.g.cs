...
namespace MTS_WebParts.KisiListesiWP {
    ...
    public partial class KisiListesiWP {
        ...
        public static implicit operator global::System.Web.UI.TemplateControl(KisiListesiWP target) 
        {
        ...
        [GeneratedCodeAttribute("Microsoft.VisualStudio.SharePoint.ProjectExtensions.CodeGenerators.SharePointWebP" +
            "artCodeGenerator", "17.0.0.0")]
        private void @__BuildControlTree(global::MTS_WebParts.KisiListesiWP.KisiListesiWP @__ctrl) {
            System.Web.UI.IParserAccessor @__parser = ((System.Web.UI.IParserAccessor)(@__ctrl));
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n\r\n<script type=\"text/javascript\">\r\n    //excele export ettikten donup sonra kal" +
                        "masin diye\r\n    function setFormSubmitToFalse() {\r\n        setTimeout(function (" +
                        ") { _spFormOnSubmitCalled = false; }, 3000);\r\n        return true;\r\n    }\r\n    f" +
                        "unction setDataSet(myset) {\r\n        myjsons = myset;\r\n    }\r\n    var myjsons = " +
                        "[{\r\n        \"KisiId\": \"\",\"AdiSoyadi\": \"\",  \"Kurumu\": \"\", \"Unvani\": \"\", \"Gorevi\":" +
                        " \"\", \"Telefon1\": \"\", \"Arama\": \"\", \"KisiKarti\": \"\", \"Duzenle\": \"\"}];\r\n    jQuery(" +
                        "document).ready(function () {\r\n\r\n        jQuery(\'#CustomDataTable\').DataTable({\r" +
                        "\n            \'initComplete\': function (settings, json) {//tablo yüklendiginde\r\n " +
                        "               var api = this.api();\r\n                var row = api.row(function" +
                        " (idx, data, node) { //secilen Id\'ye gider\r\n                    return data[\'Sec" +
                        "ildi\'] == true;\r\n                });\r\n                if (row.length > 0) {\r\n   " +
                        "                 row.select()\r\n                        .show()\r\n                " +
                        "        .draw(false);\r\n                }\r\n            },\r\n            data: myjs" +
                        "ons,\r\n            columns: [\r\n                { data: \"KisiId\" },\r\n             " +
                        ...
                        "         \"language\": {\r\n                \"url\": \"http://tskgv-portal/OrtakBelgele" +
                        "r/Turkish.txt\",\r\n                \"decimal\": \",\",\r\n                \"thousands\": \"" +
                        ".\"\r\n            },\r\n            responsive: true,\r\n            dom: \'Bfrtip\',\r\n " +
                        "           //colon resizable\r\n            //initComplete: function (settings) {\r" +

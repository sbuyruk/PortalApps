...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FaaliyetListesiROWP.ascx.cs" Inherits="MTS_WebParts.FaaliyetListesiROWP.FaaliyetListesiROWP" %>
<style>
...
<div class="container ">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-1">
                <asp:Label ID="TitleLbl" runat="server" CssClass="col-form-label text-danger font-weight-bold mb-1" Text="Faaliyet Listesi (Geçmiş İki Ay Dahil)"></asp:Label>

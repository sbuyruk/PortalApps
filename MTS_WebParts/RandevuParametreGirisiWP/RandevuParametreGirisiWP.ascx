...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RandevuParametreGirisiWP.ascx.cs" Inherits="MTS_WebParts.RandevuParametreGirisiWP.RandevuParametreGirisiWP" %>
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <div class="form-group col-3">
                <asp:DropDownList ID="RandevuGrupDDL" CssClass="form-control" runat="server" Height="34px" OnSelectedIndexChanged="RandevuGrupDDL_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
            </div>
            <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="RandevuGrupDDL" EventName="SelectedIndexChanged" />
                </Triggers>
            </asp:UpdatePanel>
        </div>

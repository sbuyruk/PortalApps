...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BolgeNakitBagisciListesiWP.ascx.cs" Inherits="BTYS_Webparts.BolgeNakitBagisciListesiWP.BolgeNakitBagisciListesiWP" %>
<style>

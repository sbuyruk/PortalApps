...
namespace BTYS_Webparts.BolgeBagisciKartiWP
{
    ...
    public partial class BolgeBagisciKartiWP : WebPart
    {
        ...
        private void BagisciBilgileriniDoldur(TasinmazBagisci bagisci)
        {
            ...
            TabloBaslikCell.Text = "Bagisçi Bilgileri";
        ...
        {
            TitleLbl.Text = bagisci.Adi + " " + bagisci.Soyadi + " Bagisçi Bilgileri";
            ...
            if (dataTable != null)
            {
                ...
                tahminiRayicCell.Text = "Tahmini Rayiç Bedelleri Toplami : " + bagis.SelectSumTahminiRayicByBagisciId(bagisci.Id).ConvertToDecimal();
        ...
        private void BagisciTalepleriniDoldur(TasinmazBagisci bagisci)
        {
            ...
            TableHeaderCell TabloBaslikCell = new TableHeaderCell();
            TabloBaslikCell.ColumnSpan = 4;
            TabloBaslikCell.Text = "Bagisçi Talepleri";
            headerRow.Controls.Add(TabloBaslikCell);
            TableHeaderRow headerRow1 = new TableHeaderRow();
            if (bagisciListesi.Count < 1)
            {
                TableHeaderCell cell1 = new TableHeaderCell();
                cell1.Text = "Bagisçi talebi bulunmamaktadir.";
        ...
        private void BagisciYakinlariniDoldur(TasinmazBagisci bagisci)
        {
            ...
            TableHeaderCell TabloBaslikCell = new TableHeaderCell();
            TabloBaslikCell.ColumnSpan = 4;
            TabloBaslikCell.Text = "Bagisçi Yakinlari";
            headerRow.Controls.Add(TabloBaslikCell);
            TableHeaderRow headerRow1 = new TableHeaderRow();
            if (bagisciListesi.Count < 1)
            {
                TableHeaderCell cell1 = new TableHeaderCell();
                cell1.Text = "Bagisçi yakinlarina ait bilgi bulunmamaktadir.";
                headerRow1.Controls.Add(cell1);
            }
            else
            {
        ...
        private void TaahhutleriDoldur(TasinmazBagisci bagisci)
        {
            ...
            TableHeaderCell TabloBaslikCell = new TableHeaderCell();
            TabloBaslikCell.ColumnSpan = 4;
            TabloBaslikCell.Text = "Bagisçiya Verilen Taahhütler";
            headerRow.Controls.Add(TabloBaslikCell);
            TableHeaderRow headerRow1 = new TableHeaderRow();
            if (taahhutListesi.Count < 1)
            {
                TableHeaderCell cell1 = new TableHeaderCell();
                cell1.Text = "Taahhüt bulunmamaktadir.";
                headerRow1.Controls.Add(cell1);
            }
            else
            {

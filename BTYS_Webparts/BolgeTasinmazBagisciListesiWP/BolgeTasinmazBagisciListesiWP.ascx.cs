    ...
    public partial class BolgeTasinmazBagisciListesiWP : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    TitleLbl.Text = "Bagisçi Listesi" + " (" + BolgeQS + " Bölgesi)";
        ...
        private List<TasinmazBagisciListItem> GetDataList()
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                tasinmazBagisciListItem.BagisciBilgiFormu = FormLinkiGetir(bagisciBilgiFormuDosyalari, ProjeConstants.DOSYA_BAGISBILGIVETALEP_FORMU, tasinmazBagisciId, "Bagisçi Bilgi ve Talep Formu", "btn btn-outline-secondary");

...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BolgeFTKListesiWP.ascx.cs" Inherits="BTYS_Webparts.BolgeFTKListesiWP.BolgeFTKListesiWP" %>
<style>
...
<div class="col-xl">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-2">
                <asp:LinkButton ID="YonergeBtn" class="btn btn-outline-primary float-right mr-4" runat="server" OnClick="YonergeBtn_Click" ToolTip="Kullanım Yönergesi"><i class="fa fa-book" aria-hidden="true"></i></asp:LinkButton>
        ...
        <div class="card-footer">
            <asp:LinkButton ID="IllereGoreFTKRaporuBtn" runat="server" CssClass="btn btn-outline-secondary float-right mr-3" Text="İllere göre FTK Dağılımı" OnClick="IllereGoreFTKRaporuBtn_Click" CausesValidation="False"></asp:LinkButton>
        </div>
    </div>

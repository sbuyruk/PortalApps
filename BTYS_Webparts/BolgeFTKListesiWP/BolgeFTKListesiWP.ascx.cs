...
namespace BTYS_Webparts.BolgeFTKListesiWP
{
    [ToolboxItemAttribute(false)]
    public partial class BolgeFTKListesiWP : WebPart
    {
        ...
        protected void IllereGoreFTKRaporuBtn_Click(object sender, EventArgs e)
        {

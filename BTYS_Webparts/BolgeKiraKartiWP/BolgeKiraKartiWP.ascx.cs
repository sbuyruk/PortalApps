...
namespace BTYS_Webparts.BolgeKiraKartiWP
{
    [ToolboxItemAttribute(false)]
    public partial class BolgeKiraKartiWP : WebPart
    {
        ...
        protected void KiraciListesiBtn_Click(object sender, EventArgs e)
        {
            try
            {
                RedirectToPage(ProjeConstants.PAGE_BOLGEKIRACI_LIST + "?SecilenId=" + KiraciIdQS);
            }
            catch (Exception ex)
            {
                ExceptionHelper exHelper = new ExceptionHelper(ex);
        ...
        protected void TumunuSecChk_CheckedChanged(object sender, EventArgs e)
        {
            ...
            RedirectToPage(ProjeConstants.PAGE_BOLGEKIRA_KARTI + "?SenderApp=" + SenderAppQS + "&KiraciId=" + KiraciIdQS + "&SelectAll=" + SelectAllQS);
        }
    }
}

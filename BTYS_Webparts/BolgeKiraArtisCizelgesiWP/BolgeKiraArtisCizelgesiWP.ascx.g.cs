...
namespace BTYS_Webparts.BolgeKiraArtisCizelgesiWP {
    ...
    public partial class BolgeKiraArtisCizelgesiWP {
        ...
        public static implicit operator global::System.Web.UI.TemplateControl(BolgeKiraArtisCizelgesiWP target) 
        {
        ...
        private global::System.Web.UI.WebControls.Label @__BuildControlTitleLbl() {
            ...
            @__ctrl.ID = "TitleLbl";
            @__ctrl.Text = "Kira Artis Çizelgesi";
            return @__ctrl;
        }
        ...
        [GeneratedCodeAttribute("Microsoft.VisualStudio.SharePoint.ProjectExtensions.CodeGenerators.SharePointWebP" +
            "artCodeGenerator", "17.0.0.0")]
        private void @__BuildControlTree(global::BTYS_Webparts.BolgeKiraArtisCizelgesiWP.BolgeKiraArtisCizelgesiWP @__ctrl) {
            System.Web.UI.IParserAccessor @__parser = ((System.Web.UI.IParserAccessor)(@__ctrl));
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n<style>\r\n    .bes-yil{ \r\n        color: orange;\r\n        font-weight:bold;\r\n   " +
                        " }\r\n    .on-yil{ \r\n        color: red;\r\n        font-weight:bold;\r\n    }\r\n</styl" +
                        ...
                        "    }\r\n            //},\r\n            \'order\': [[2, \'asc\']],//AdiSoyadi Sirali\r\n " +
                        "           \"language\": {\r\n                \"url\": \"http://tskgv-portal/OrtakBelge" +
                        "ler/Turkish.txt\",\r\n                \"decimal\": \",\",\r\n                \"thousands\":" +
                        " \".\"\r\n            },\r\n            responsive: true,\r\n            dom: \'Bfrtip\',\r" +
                        ...
                        "olumns: \':visible\'\r\n                    }\r\n                },\r\n                {" +
                        "\r\n                    extend: \'excelHtml5\',\r\n                    customize: func" +
                        "tion (xlsx) {\r\n                        var sheet = xlsx.xl.worksheets[\'sheet1.xm" +
                        "l\'];\r\n\r\n                        var count = 0;\r\n                        var skip" +
                        "pedHeader = 0;\r\n\r\n                        //$(\'row\', sheet).each(function () {\r\n" +
                        "                        //    if (skippedHeader++>1) {\r\n                        " +
                        "//        var text = $(\'tbody tr:eq(\' + parseInt(count) + \') td:eq(4)\').text();\r" +
                        "\n                        //        if (text == \'5 Yil\') {\r\n                     " +
                        "   //            $(this).attr(\'s\', \'11\');\r\n                        //        }\r\n" +
                        "                        //        else {\r\n                        //            " +
                        "$(this).attr(\'s\', \'21\');\r\n                        //        }\r\n                 " +
                        ...
                        "py\',\r\n                    exportOptions: {\r\n                        columns: \':v" +
                        "isible\'\r\n                    }\r\n                },\r\n                , \'pageLengt" +
                        "h\', \"colvis\"\r\n            ],\r\n            \"createdRow\": function (row, data, dat" +
                        "aIndex) {\r\n                if (data.OnYil == \"True\") {\r\n                    $(ro" +

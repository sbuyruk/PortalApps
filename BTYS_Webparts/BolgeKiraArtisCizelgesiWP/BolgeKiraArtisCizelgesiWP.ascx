...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BolgeKiraArtisCizelgesiWP.ascx.cs" Inherits="BTYS_Webparts.BolgeKiraArtisCizelgesiWP.BolgeKiraArtisCizelgesiWP" %>
<style>
    .bes-yil{ 
        color: orange;
        font-weight:bold;
    ...
    jQuery(document).ready(function () {
        ...
        var table = jQuery('#CustomDataTable').DataTable({
            ...
            columns: [
                ...
                { data: "YeniKiraBedeli", type: "decimal"},
                { data: "YenilendiMi" },

            ],
            //"rowCallback": function (row, data, index) {
            //    var yil = data.KiraSuresi;
            //    yil = yil.replace(" Yil", "");
            ...
            //        $('td:eq(4)', row).css('background-color', 'Blue');
            //    }
            //},
...
<div class="col-xl">
    <div class="card shadow">
        <div class="card-header" id="CardHeader" runat="server">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-danger font-weight-bold mb-1" ID="TitleLbl" runat="server" Text="Kira Artış Çizelgesi"></asp:Label>

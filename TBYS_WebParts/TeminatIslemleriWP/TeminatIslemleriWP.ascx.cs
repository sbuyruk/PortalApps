...
namespace TBYS_WebParts.TeminatIslemleriWP
{
    ...
    public partial class TeminatIslemleriWP : WebPart
    {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (KiraSozlesmeIdQS.ConvertToInt() > 0)
                    {
                        ...
                        if (kiraci != null)
                        {
                            ...
                            SozlesmeLbl.Text = " ( " +kiraSozlesme.SozBasTar.ConvertToDatetimeEmptyIfNull() + " - " + kiraSozlesme.SozBitTar.ConvertToDatetimeEmptyIfNull() + " Tarihli Sözlesme )";
                        }
        ...
        private void SozlesmeTasinmazTablosunuDoldur(KiraSozlesme kiraSozlesme)
        {
            ...
            string[] headers = { "Sira", "Tasinmaz Adresi" };
            ...
            if (dataTable != null)
            {
                ...
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    if (sira > 2 && dataTable.Rows.Count>3)
                    {
                        ...
                        adresCell1.Text = " +"+(dataTable.Rows.Count-3)+" Tasinmaz daha... (Toplam "+ dataTable.Rows.Count+" Tasinmaz.)";
        ...
        {
            string titleStr ="'" + AdiLbl.Text + " Teminat Islemleri" +"'";
        ...
        protected void ModalEkleBtn_Click(object sender, EventArgs e)
        {
            ...
            if (kiraSozlesme != null)
            {
                ...
                ModalTitleLbl.Text = "Teminat Islemi Eklenecek";
        ...
        protected void ModalGuncelleBtn_Click(object sender, EventArgs e)
        {
            ...
            if (teminatIslem != null)
            {
                ...
                ModalTitleLbl.Text = "Teminat Islemi Degistirilecek";
        ...
        protected void ModalSilBtn_Click(object sender, EventArgs e)
        {
            ...
            if (teminatIslem != null)
            {
                SilmeMesajiLbl.Text = teminatIslem.IslemTarihi.ConvertToDatetimeEmptyIfNull() + " tarihli ve " + teminatIslem.IslemTutari.ToString("N", culturInfo) + " tutarli '" + teminatIslem.IslemTipi + "' islemi silinecek.";
        ...
        protected void ModalEkleNowBtn_Click(object sender, EventArgs e)
        {
            ...
            if (kiraSozlesme != null)
            {
                ...
                {
                    MessageHelper.PublishMessage("Mahsup edilecek bir sözlesme bulunamadi", ProjeConstants.MESAJ_HATA);
                }
                ...
                if (teminatIslem.Update())
                {
                    ...
                    if (kiraSozlesme != null)
                    {
                        ...
                        if (mahsupEdilecekKiraSozlesme != null)
                        {
                            ...
                            TeminatBilgileriniDoldur(kiraSozlesme);
                            TabloOlustur(kiraSozlesme.KiraciId);
                            MessageHelper.PublishMessage("Teminat Islemi Güncellendi", ProjeConstants.MESAJ_BASARILI, 2000);
                            if (teminatIslem.IslemTipi.Equals(ProjeConstants.TEMINAT_KIRAYAMAHSUP))
                            {
                    ...
                    {
                        MessageHelper.PublishMessage("Teminata ait sözlesme bulunamadi!", ProjeConstants.MESAJ_HATA);
                    }
                }
            }
            else
            {
                MessageHelper.PublishMessage("Teminat Islemi bulunamadi!", ProjeConstants.MESAJ_HATA);
            }
        ...
        protected void ModalSilNowBtn_Click(object sender, EventArgs e)
        {
            ...
            if (teminatIslem != null)
            {
                ...
                if (kiraSozlesme != null)
                {
                    ...
                    TeminatBilgileriniDoldur(kiraSozlesme);
                    TabloOlustur(kiraSozlesme.KiraciId);
                    MessageHelper.PublishMessage("Teminat Islemi Silindi", ProjeConstants.MESAJ_BASARILI, 2000);
                }
                else
                {
                    MessageHelper.PublishMessage("Teminat Islemi Silindi. Teminata ait sözlesme bulunamadi!", ProjeConstants.MESAJ_BILGI, 4000);
                }
            }
            else
            {
        ...
        protected void SozlesmeyeGitBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageHelper.PublishMessage("Sözlesme kaydi bulunamadi", ProjeConstants.MESAJ_HATA);
            }
        }

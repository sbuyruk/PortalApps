...
namespace TBYS_WebParts.KiraArtisYazisiWP
{
    ...
    public partial class KiraArtisYazisiWP : WebPart
    {
        ...
        //{
        //    var jsonData = KiraArtisJson(); //veri çekilip json a çeviriliyor
        ...
        //        TableDataLbl.Text = "Kira artışı yapılacak kiracı bulunmamaktadır.";
        ...
        //                    },
        //        columns: [
        //            { field: 'KiraciAdi', headerText: 'Kiracı',filter: true,sortable:true,headerStyle:'width: 14%' , content: function (rowData)
        //                { 
        //                    return $('<a href=" + ProjeConstants.PAGE_KIRACI_GIRIS + @"?DestinationApp=KD&SenderApp=KAC&KiraciId='+rowData.KiraciId +' class=\'text-link \'>'+rowData.KiraciAdi +'</a>')
        //                }
        //            },   
        //            { field: 'KiralamaAmaci', headerText: 'Cinsi',filter: true,sortable:true,headerStyle:'width: 9%' },  
        //            { field: 'Bolge', headerText: 'Bölge',filter: true,headerStyle:'width: 9%' },                    
        //            { field: 'SozlesmeTarihi', headerText: 'İlk Söz.Tar.',headerStyle:'width: 9%' },
        //            { field: 'ArtisAyi', headerText: 'Art.Ayı',filter: true ,sortable:true,headerStyle:'width: 6%' },
        //            { field: 'TamAdres', headerText: 'Adres',filter: true,headerStyle:'width: 20%', content: function (rowData)
        //                { 
        //                    return rowData.TamAdres.replace(/@/g,'<br>- ');
        //                }
        //            },
                    
        //            { field: 'KiraBedeli', headerText: 'Eski Kira',bodyClass:'text-right',headerStyle:'width: 9%' },
        //            { field: 'Tufe', headerText: 'Tüfe (%)',bodyClass:'text-right',headerStyle:'width: 6%' },
        //            { field: 'YeniKiraBedeli', headerText: 'Yeni Kira',bodyClass:'text-right',headerStyle:'width: 9%' },
        //            { field: 'YenilendiMi', headerText: 'Durumu',bodyClass:'text-right',headerStyle:'width: 9%' }
        //        ],
        //        datasource:" + jsonData + @",

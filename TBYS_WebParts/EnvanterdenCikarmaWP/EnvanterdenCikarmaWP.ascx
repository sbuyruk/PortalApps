                    ...
                    <div class="form-group m-0 ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-2">
                                ...
                                <div>
                                    <input runat="server" type="text" id="EnvanterdenCikmaTarTxt" name="EnvanterdenCikmaTarTxt" class="form-control DateTimePickerV1 input-date" placeholder="gg.aa.yyyy" />
                                </div>
                            </div>

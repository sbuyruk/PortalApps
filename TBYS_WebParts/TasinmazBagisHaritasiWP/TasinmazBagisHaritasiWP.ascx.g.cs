...
namespace TBYS_WebParts.TasinmazBagisHaritasiWP {
    ...
    public partial class TasinmazBagisHaritasiWP {
        ...
        private global::System.Web.UI.WebControls.Label @__BuildControl__control2() {
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("Tasinmaz Bagis Haritasi"));
            return @__ctrl;
        }
...
<script type=""text/javascript"">
    $(function () {
        ...
        $(""#map svg path"").click(function () {//tiklayinca
            var id = $(this).attr(""id"");
            ...
            <div>
                <table class=""colors"">
                    <tr>
                        ...
                        <td style=""width: 15%"">Istanbul Bölge Tem. </td>

                        <td style=""background-color: orange; width: 5%;""></td>
                        <td style=""width: 15%"">Izmir Bölge Tem. </td>

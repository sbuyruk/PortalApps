...
namespace TBYS_WebParts.KiraSozlesmeSiralamaWP {
    ...
    public partial class KiraSozlesmeSiralamaWP {
        ...
        private global::System.Web.UI.WebControls.Label @__BuildControlTitleLbl() {
            ...
            @__ctrl.ID = "TitleLbl";
            @__ctrl.Text = "Kira Sözlesme Siralama";
            return @__ctrl;
        }
        ...
        private void @__BuildControl__control3(System.Web.UI.Control @__ctrl) {
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl(@"
                ...
                <div class=""card-footer"">
                    <button id=""kaydetBtn"" class=""btn btn-outline-primary"" type=""button"" onclick=""SiralamayiKaydet();"">Siralamayi Kaydet</button>
                </div>
...
<script>
    ...
    function storeTblValues() {
        ...
        $('#CustomDataTable tr').each(function (row, tr) {
            tableData +=
                $(tr).find('td:eq(1)').text() + "",""; //kiraSozlesmeId lerini "","" ile ayirarak ekle
        });
        return tableData;
    }

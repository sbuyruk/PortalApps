...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KiraGeliriTahakkukTahsilWP.ascx.cs" Inherits="TBYS_WebParts.KiraGeliriTahakkukTahsilWP.KiraGeliriTahakkukTahsilWP" %>
        ...
        <ContentTemplate>
            <div class="card shadow">
                <div class="card-header" id="CardHeader" runat="server">
                    ...
                    <h3 class="mb-2">
                        <asp:Label CssClass="col-form-label text-danger fw-bold text-center" ID="TitleLbl" runat="server" Text="YILI AYLIK KİRA GELİRLERİ"></asp:Label>

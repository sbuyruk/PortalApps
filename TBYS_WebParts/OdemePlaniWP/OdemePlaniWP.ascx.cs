    ...
    public partial class OdemePlaniWP : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(KiraSozlesmeIdQS))
            {
                ...
                {
                    AdiLbl.Text = KiraciGetir(kiraSozlesme.KiraciId) + "( Sözlesme : " + kiraSozlesme.SozBasTar.ConvertToDatetimeEmptyIfNull() + " - " + kiraSozlesme.SozBitTar.ConvertToDatetimeEmptyIfNull() + ")";
        ...
        private void OdemePlaniTablosunuDoldur(KiraSozlesme kiraSozlesme)
        {
            ...
            foreach (OdemePlani op in odemePlaniListesi)
            {
                ...
                VadeBasTarBtn.Click += delegate
                {
                    ...
                    PopupMesajLbl.Text = "Vade Tarihi Degistirme";
                ...
                {
                    HiddenOdemePlaniId.Value = op.Id.ToString();
                    PopupMesajLbl.Text = "Kira Bedeli Degistirme";
        ...
        protected void OdemePlaniEkleBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageHelper.PublishMessage("Bu sözlesme için ödeme Plani olusturulamaz. Ödeme Plani olusturabilmek için, Lütfen Kira Sözlesmesinde Sözlesme Baslangiç ve Bitis tarihini giriniz", ProjeConstants.MESAJ_HATA);
            }
            else
            {
        ...
        private void EnableDisableOdemePlaniEkleBtn()
        {
            ...
            if (string.IsNullOrEmpty(kiraSozlesme.SozBasTar.ConvertToDatetimeEmptyIfNull()) || string.IsNullOrEmpty(kiraSozlesme.SozBitTar.ConvertToDatetimeEmptyIfNull()))
            {
                ...
                MessageHelper.PublishMessage("Ödeme plani olusturulamiyor. Lütfen sözlesmenin baslama ve bitis tarihlerini girerek tekrar deneyin.", ProjeConstants.MESAJ_HATA);
            }
        ...
        private bool OdemePlaniniKontrolEtVeOlustur()
        {
            ...
            else
            {
                ...
                {
                    MessageHelper.PublishMessage("Ödeme Plani Olusturulamaz. Zaten geçerli bir ödeme plani mevcut.", ProjeConstants.MESAJ_HATA);
                }
            }

            if (isSaved)
            {
                MessageHelper.PublishMessage("Ödeme Plani Olusturuldu. Ödeme plani geçerlilik Tarihi" + kiraSozlesme.SozBitTar + " -" + kiraSozlesme.SozBitTar, ProjeConstants.MESAJ_BASARILI, 2000);
            }
            return isSaved;
        }

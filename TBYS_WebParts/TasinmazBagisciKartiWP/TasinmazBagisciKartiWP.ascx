...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TasinmazBagisciKartiWP.ascx.cs" Inherits="TBYS_WebParts.TasinmazBagisciKartiWP.TasinmazBagisciKartiWP" %>

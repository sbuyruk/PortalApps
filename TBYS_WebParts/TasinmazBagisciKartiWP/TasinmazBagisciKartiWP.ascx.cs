    ...
    public partial class TasinmazBagisciKartiWP : WebPart
    {
        ...
        private void TasinmazListesiniDoldur(TasinmazBagisci bagisci)
        {
            ...
            if (dataTable != null)
            {
                ...
                tahminiRayicCell.Text = "Tahmini Rayiç Bedelleri Toplami : " + bagis.SelectSumTahminiRayicByBagisciId(bagisci.Id).ReturnZeroIfNull().ConvertToDecimal().ToString("N", culturInfo);

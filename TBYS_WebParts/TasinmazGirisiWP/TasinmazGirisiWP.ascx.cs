    ...
    public partial class TasinmazGirisiWP : WebPart
    {
        ...
        private void GorunumAyarlariniYap()
        {
            if (TasinmazIdQS.ConvertToInt() > 0)
            {
                ...
                TitleLbl.Text = "Tasinmaz Bilgi Güncelleme";
                IdLbl.Visible = true;
            }
            else
            {
            ...
            if (EnvanterdeMiQS.Equals(ProjeConstants.TASINMAZ_ENVANTERDEN_CIKTI.ToString()))
            {
                ...
                TitleLbl.Text = "Envanterden Çikarilmis Tasinmaz";
            }
        ...
        private void EdinmeSekliDDLDoldur()
        {
            ...
            EdinmeSekliDDL.Items.Add("Kamulastirma (Tümü)");
        ...
        protected void UpdateBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                TasinmazDuzenle();
                MessageHelper.PublishMessage("Tasinmaz kaydi güncellendi.", ProjeConstants.MESAJ_BASARILI, 2000);
            }
            else
            {
                MessageHelper.PublishMessage("Tasinmaz Güncellenemedi.-TS001", ProjeConstants.MESAJ_HATA);
            }
        }
...
#pragma warning restore CS0162 // Unreachable code detected
                ...
                if (tasinmaz != null) //sildikten sonra önceki sayfaya dön
                {
                    ...
                    {
                        MessageHelper.PublishMessage("Tasinmaza ait sözlesme bulunmaktadir. Tasinmaz silinemez.", ProjeConstants.MESAJ_HATA);
                    }
                }
                else
                    MessageHelper.PublishMessage("Tasinmaz bulunamadi", ProjeConstants.MESAJ_HATA);
        ...
        protected void BagisciBtn_Click(object sender, EventArgs e)
        {
            ...
            if (bagis == null)
            {
                MessageHelper.PublishMessage("Bagisçi Bulunamadi. Bu tasinmaz henüz bir bagisçiyla iliskilendirilmemis. Lütfen Bagisçi sayfasindan bagisçi atamasi yapiniz.", ProjeConstants.MESAJ_HATA);
            }
            else
            {
                TasinmazBagisci bagisci = new TasinmazBagisci();
                ...
                if (bagisci == null)
                {
                    MessageHelper.PublishMessage("Bagisçi Bulunamadi. Bu tasinmazin iliskilendirilildigi bagisçi bulunamadi. Lütfen Bagisçi sayfasindan bagisçi atamasi yapiniz.", ProjeConstants.MESAJ_HATA);
                }
                else
                {
                    string currentUrl = System.Web.HttpContext.Current.Request.Url.ToString();
        ...
        protected void KopyalaBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MesajLbl.Text = "Tasinmaza bagli Bagisçi, Kira Sözlesmesi, Ödeme Plani, Sigorta ve Onarim islemleri gibi bilgiler aktarilacak.";
        ...
        private void SerhBeyanIrtifakDivModalAc(string islemTipi,int serhBeyanIrtifakId=0)
        {
            ...
            else if(islemTipi.Equals(ProjeConstants.GUNCELLE))
            {
                if (serhBeyanIrtifakId > 0)
                {
                    //SerhBeyanIrtifakDiv modalini aç
                    //SerhBeyanIrtifakDiv içindeki alanlari hazirla
                    ModalBaslikLbl.InnerText = "Serh Beyan ve Irtifak Düzenle";
                    SerhBeyanIrtifakDDLDoldur();

                    //Seçilen Serh Beyan ve Irtifak kaydini getir
        ...
        protected void SBIGuncelleBtn_Click(object sender, EventArgs e)
        {
            ...
            if (sbi != null)
            {
                ...
                if (sbi.Update())
                {
                    ...
                    tasinmaz = tasinmaz.Select<Tasinmaz>(TasinmazIdQS.ConvertToInt());
                    SerhBeyanIrtifakTabloOlustur(tasinmaz);
                    MessageHelper.PublishMessage("Serh Beyan ve Irtifak kaydi güncellendi.", ProjeConstants.MESAJ_BASARILI, 2000);
                }
                else
                {
                    MessageHelper.PublishMessage("Serh Beyan ve Irtifak kaydi güncellenemedi.", ProjeConstants.MESAJ_HATA);
                }
                UtilityHelper.ScriptCalistir("setActiveTab('SerhBeyanIrtifakLi');");
            }
        }

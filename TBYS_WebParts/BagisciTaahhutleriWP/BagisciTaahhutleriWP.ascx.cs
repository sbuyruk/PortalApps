...
namespace TBYS_WebParts.BagisciTaahhutleriWP
{
    ...
    public partial class BagisciTaahhutleriWP : WebPart
    {
        ...
        private void BagisciyiTaahhutListesineEkleBtnGoster(TasinmazBagisci bagisci)
        {
            ...
            {
                MessageHelper.PublishMessage("Bagisçinin TC Kimlik Numarasi girilmemis.", ProjeConstants.MESAJ_BILGI, 2000);
            }
        }
        ...
        protected void TaahhutModalDoldurBtnBtn_Click(object sender, EventArgs e)
        {
            ...
            if (tasinmazTaahhut != null)
            {
                ...
                TaahhutAciklamaTxt.Text = string.IsNullOrEmpty(tasinmazTaahhut.TaahhutAciklama)? "Vakif tarafindan taahhütname verilmistir.": tasinmazTaahhut.TaahhutAciklama;
            ...
            else
            {
                ...
                TaahhutAciklamaTxt.Text = "Vakif tarafindan taahhütname verilmistir.";
        ...
        protected void TaahhutSilNowBtn_Click(object sender, EventArgs e)
        {
            ...
            if (tt != null)
            {
                ...
                MessageHelper.PublishMessage("Taahhüt bulunamadi", ProjeConstants.MESAJ_BILGI);
        }
            ...
            try
            {
                ...
                if (tasinmazBagisci != null )
                {
                    ...
                    if (tt == null || tasinmazBagisci.TCKimlikNo == 0)
                    {
                        ...
                        yeniTaahhut.TaahhutAciklama = "Bagisçiya taahhüt verilmistir.";
                    ...
                    {
                        MessageHelper.PublishMessage("Bagisçi zaten listede var.",ProjeConstants.MESAJ_BILGI, 2000);
                    }
                }
                else
                {
                    MessageHelper.PublishMessage("Bagisçi bulunamadi.", ProjeConstants.MESAJ_BILGI, 2000);
                }
            }
            catch (Exception ex)
            {

    ...
    public partial class TasinmazBagisciListesiWP : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    TitleLbl.Text = "Tasinmaz Bagisçi Listesi";
                    if (BolgeIdQS!= ProjeConstants.BOLGE_HEPSI_INT && BolgeIdQS!=ProjeConstants.BOLGE_GENELMUDURLUK_INT)
                    {
                        ...
                        TitleLbl.Text = bolgeDao==null? "Tasinmaz Bagisçi Listesi" : "Bagisçi Listesi" + " (" + bolge.KisaAdi + " Bölgesi )";
        ...
        private List<TasinmazBagisciListItem> GetDataList()
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                tasinmazBagisciListItem.TasinmazBagisciKarti = "<a target='_blank' href=" + ProjeConstants.PAGE_TASINMAZBAGISCI_KARTI + "?SenderApp=TBL&BagisciId=" + tasinmazBagisciId + " class='btn btn-outline-info'>Bagisçi Karti</a>";

                tasinmazBagisciListItem.BagisciBilgiFormu = FormLinkiGetir(bagisciBilgiFormuDosyalari, ProjeConstants.DOSYA_BAGISBILGIVETALEP_FORMU,tasinmazBagisciId.ToString(), "Bagisçi Bilgi ve Talep Formu", "btn btn-outline-secondary");
        ...
        //    if (dosyaVarMi)
        //    {
        //        belgePdfLink = @"<a class='btn btn-outline-secondary' data-fancybox data-type=pdf data-width=960 data-height=720 href=" + dosyaUrl + @">Bagisçi Bilgi ve Talep Formu</a>";
        //    }
        //    return belgePdfLink;
        //}
        ...
        private void TaahhutTableHeaders()
        {
            ...
            IliIlcesiCell.Text = "Ikamet adresi";
            ...
            AciklamaCell.Text = "Taahhüt Açiklama";

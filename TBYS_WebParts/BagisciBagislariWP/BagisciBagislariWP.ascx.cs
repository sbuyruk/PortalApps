    ...
    public partial class BagisciBagislariWP : WebPart
    {
        ...
        private void BagisciTasinmazlarTablosunuDoldur(TasinmazBagisci bagisci)
        {
            ...
            if (dataTable != null)
            {
                ...
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    ...
                    {
                        CikarLbl.Text = "Lütfen Dikkat: Tasinmaz Bagislardan Çikarilacak";
                        CikarMesajiLbl.Text = "Seçilen Tasinmazi Bagislardan Çikarmak Istediginizden Emin misiniz?";
        ...
        protected void CikarNowBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (bagis != null)
                {
                    ...
                    if (isDeleted)
                    {
                        ...
                        MessageHelper.PublishMessage("Bagislardan Çikarildi", ProjeConstants.MESAJ_BASARILI, 2000);
                    }
                }
            }
            catch (Exception exception)
            {
                ...
                Exception exceptionInfo = new Exception("Tasinmaz Bagislardan Çikarilamadi");

            ...
            foreach (KiraEkstreAktarma ekstreAktarma in listEkstreAktarma)
            {
                ...
                try
                {
                    ...
                    if (kiraSozlesme != null)
                    {
                        ...
                        {
                            throw new Exception("Ödeme Zaten Kaydedilmis!");
                        }
                    }
                    else
                    {
        ...
        private List<KiraEkstreAktarmaListItem> GetDataList()
        {
            ...
            if (dataTable != null)
            {
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    ...
                    {
                        MessageHelper.PublishMessage("Islem Tamamlanamadi. EkstreAktarmaId=" + ekstreAktarmaListItem.KiraEkstreAktarmaId, ProjeConstants.MESAJ_HATA);
                    }
        ...
        private string OdemeAyristirBtnLinki( KiraEkstreAktarmaListItem ekstreAktarmaListItem, bool aktarildiMi)
        {
            ...
            if (ekstreAktarmaListItem!=null)
            {
                ...
                string link = "<a id=" + odemeAyristirBtnId + visibility +
                    ...
                    "?KiraEkstreAktarmaId=" + ekstreAktarmaListItem.KiraEkstreAktarmaId + classofbutton + " >Ödemeyi Ayristir ve Kaydet</a>";

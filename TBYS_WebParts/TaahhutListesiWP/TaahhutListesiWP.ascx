...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaahhutListesiWP.ascx.cs" Inherits="TBYS_WebParts.TaahhutListesiWP.TaahhutListesiWP" %>
...
<div class="container col-xl ">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-1">
                <asp:Label ID="TitleLbl" runat="server" CssClass="col-form-label text-danger font-weight-bold mb-1" Text="Taahhüt Listesi"></asp:Label>
            ...
            <div class="form-group">
                <table id="CustomDataTable" class="table table-striped row-border" width="100%">
                    <thead>
                        <tr>
                            <th>Bağışçı</th>
                            <th>Kullanım İzni Verilen Kişi</th>
                            <th>TCKimlikNo</th>
                            <th>Doğum Tarihi</th>
                            <th>Sağ/Vefat</th>
                            <th>Taşınmaz</th>                           

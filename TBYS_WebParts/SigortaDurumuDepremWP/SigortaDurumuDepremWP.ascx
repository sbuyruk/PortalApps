...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SigortaDurumuDepremWP.ascx.cs" Inherits="TBYS_WebParts.SigortaDurumuDepremWP.SigortaDurumuDepremWP" %>
...
<div id="MainContainer" class="container">
    <div class="card shadow">
        <div class="card-header" id="CardHeader" runat="server">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-danger font-weight-bold text-center" ID="TitleLbl" runat="server" Text="Sigorta Durumu (Deprem+İhtiyari)"></asp:Label>
        ...
        <div class="card-body" id="TasimazDurumuPanel" runat="server">
            ...
            <div>
                ...
                <input class="input-money text-right" id="SigortaBedeliTopTxt" runat="server" readonly />
                <strong>Prim Toplam         :  </strong>
                <input class="input-money text-right" id="PrimTopTxt" runat="server" readonly />
            </div>
        </div>

...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TeminatListesiWP.ascx.cs" Inherits="TBYS_WebParts.TeminatListesiWP.TeminatListesiWP" %>
...
<div class="container col-xl">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-1">
                <asp:Label ID="TitleLbl" runat="server" CssClass="col-form-label text-danger font-weight-bold mb-1" Text="Teminat Listesi"></asp:Label>

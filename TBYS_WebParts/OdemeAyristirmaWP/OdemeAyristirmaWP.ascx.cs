    ...
    public partial class OdemeAyristirmaWP : WebPart
    {
            ...
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (kiraEkstreAktarma!=null)
                    {
                        ...
                        TabloOlustur(kiraEkstreAktarma);//aktarildi ise buttonlari göstermesin
                    ...
                    {
                        MessageHelper.PublishMessage("Ödeme Bulunamadi.", ProjeConstants.MESAJ_HATA);
                    }
                }
            }
        ...
        private void OdemeAyristirmaTabledanDoldur(KiraEkstreAktarma kiraEkstreAktarma)
        {
            ...
            if (dataTable != null)
            {
                ...
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    ...
                    odemeListItem.Kiraci = kiraci +"(KiraciNo:"+kiraciId+" SözlesmeNo:"+ odemeListItem.KiraSozlesmeId+")";

                    OdemeAyristirmaListQS.Add(odemeListItem);
                    if (ToplamlariDuzenle(kiraEkstreAktarma.AktarildiMi))
                    {
                        OdemeAyristirmaListQS.Remove(odemeListItem);//ödenen tutar asildi ise listeden çikar
                    }
                }
            }
        }
        ...
        protected void ListeyeEkleNowBtn_Click(object sender, EventArgs e)
        {
            ...
            if (kiraEkstreAktarma!=null)
            {
                ...
                {
                    MessageHelper.PublishMessage("Ödenen tutari astiniz.", ProjeConstants.MESAJ_HATA, 2000);
                } 
            }
            TabloOlustur(kiraEkstreAktarma);
        ...
        protected void ListeyiGuncelleNowBtn_Click(object sender, EventArgs e)
        {
            ...
            if (islemTutari >= 0)
            {
                ...
                {
                    odemeListItem.Tutar = oncekiTutar;//ödenen tutar asildi ise eski tutara dön
                }
            }
            else
            {
        ...
        private bool ToplamlariDuzenle(bool aktarildiMi)
        {
            ...
            {
                toplamAsildiMi = true;
                MessageHelper.PublishMessage("Toplam ödenen tutari astiniz, girdiginiz tutar listeye eklenmedi.", ProjeConstants.MESAJ_HATA, 2000);
            }
            else
            {

...
namespace TBYS_WebParts.TasinmazKartiWP
{
    ...
    public partial class TasinmazKartiWP : WebPart
    {
        ...
        private void TasinmazBilgileriniDoldur(Tasinmaz tasinmaz)
        {
            ...
            r2c1.Text = "Mülkiyet Sekli : " + tasinmaz.MulkiyetSekli;
        ...
        {
            RedirectToPage(ProjeConstants.PAGE_TASINMAZ_LIST + "?TasinmazId=" + TasinmazIdQS + "&EnvanterdeMi=" + EnvanterdeMiQS);
        }

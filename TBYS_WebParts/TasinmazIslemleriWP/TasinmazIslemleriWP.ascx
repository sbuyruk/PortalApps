...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TasinmazIslemleriWP.ascx.cs" Inherits="TBYS_WebParts.TasinmazIslemleriWP.TasinmazIslemleriWP" %>
                ...
                <div class="card-header" id="CardHeader" runat="server">
                    ...
                    <h3 class="mb-2">
                        ...
                        <div class="form-group m-0 float-end me-2">
                            <%--<label class="form-label fw-semibold" for="SorumluBolgeTxt">Id</label>--%>
                        ...
                        <div class="form-group m-0 float-end">
                            ...
                            <%--<asp:TextBox ID="SorumluBolgeTxt" runat="server" class="form-control" ToolTip="Sorumlu Bölge/Temsilcilik" ReadOnly="true" Visible="False"></asp:TextBox>--%>
                            <asp:TextBox ID="SorumluBolgeIdTxt" runat="server" class="form-control" ToolTip="Sorumlu Bölge/Temsilcilik" ReadOnly="true" Visible="False"></asp:TextBox>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <div class="form-group m-0 ">
                                                        <label class="form-label fw-semibold" for="KatMulkiyetiDDL">Tapu Tipi</label>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group m-0 ">
                                                    <label class="form-label fw-semibold" for="SBITesisEdenKurumTxt">Tesis Eden</label>
                                                    <asp:TextBox ID="SBITesisEdenKurumTxt" runat="server" CssClass="form-control" ToolTip="Bağış Yılı"></asp:TextBox>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="form-group m-0 ">
                                                    <label class="form-label fw-semibold" for="SBITarihiTxt">Tarih</label>
                                                    <input runat="server" type="text" id="SBITarihiTxt" name="SBITarihiTxt" class="form-control DateTimePickerV1" readonly="readonly" />
                                                </div>
                                            </div>
                                            <div class="col">

                                                <div class="form-group m-0 ">
                                                    <label class="form-label fw-semibold" for="SBIYevmiyeNoTxt">Yevmiye No</label>
                                                    <asp:TextBox ID="SBIYevmiyeNoTxt" runat="server" CssClass="form-control" ToolTip="ŞBİ Yevmiye No"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group m-0 ">
                                            <label class="form-label fw-semibold" for="SBIAciklamaTxt">Açıklama</label>
                                            <asp:TextBox ID="SBIAciklamaTxt" runat="server" class="form-control" TextMode="MultiLine" Rows="3" ToolTip="Ş/B/İ Açıklama"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    ...
                                    <div class="card-body">
                                        <!-- Mülkiyet Bilgileriiçeriği buraya -->
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group m-0 ">
                                                ...
                                                <div class="form-group m-0 ">
                                                    <label class="col-form-label" for="ToplamMetrekareTxt">Toplam Metrekare</label>
                                                    <asp:TextBox ID="ToplamMetrekareTxt" runat="server" class="form-control input-money" ToolTip="Metrekaresi"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="SagVefatDDL" CssClass="form-control" runat="server" Height="34px" AutoPostBack="true" OnSelectedIndexChanged="SagVefatDDL_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                            ...
                            <div id="BelgeYukleDiv" runat="server" class="form-group">
                                <div class="card p-1">
                                    <div>
                                        <asp:FileUpload ID="BekleYukleFU" class="btn btn-danger form-control" runat="server" ToolTip="Yüklenecek Dosyayı Seçiniz" type="text" />
                                    </div>
                                    <div class="card-footer">
                                        <asp:LinkButton ID="YukleBtn" CssClass="btn btn-outline-success" runat="server" Text="Vasiyet PDF Yükle" OnClick="YukleBtn_Click"></asp:LinkButton>
                                        <asp:HyperLink ID="DosyaLnk" runat="server" CssClass="btn btn-outline-primary" Visible="false" Font-Size="Small">Vasiyet PDF Görüntüle</asp:HyperLink>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="VasiyetinDurumuDDL" runat="server" CssClass="form-control" Height="34px"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <asp:Label CssClass="col-from-label" runat="server" Text="Vasiyetçinin Talebi"></asp:Label>
                                        <asp:TextBox ID="VasiyetcininTalebiTxt" CssClass="form-control" runat="server" TextMode="MultiLine" Rows="3" Text=""></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="AciklamaTxt" CssClass="form-control" runat="server" TextMode="MultiLine" Rows="3" Text=""></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div id="VasiyetNitelikDiv" runat="server" class="form-group">
                                <div class="card p-1">
                                    <asp:Table ID="VasiyetNitelikTable" runat="server" CssClass="table table-bordered table-hover table-striped">
                                        <asp:TableHeaderRow HorizontalAlign="Center">
                                            <asp:TableHeaderCell BorderStyle="Solid" BorderWidth="2" BorderColor="Black" Style="vertical-align: Middle">Cinsi</asp:TableHeaderCell>
                                            <asp:TableHeaderCell BorderStyle="Solid" BorderWidth="2" BorderColor="Black" Style="vertical-align: Middle">Niteliği</asp:TableHeaderCell>
                                            <asp:TableHeaderCell BorderStyle="Solid" BorderWidth="2" BorderColor="Black" Style="vertical-align: Middle">T.Rayiç</asp:TableHeaderCell>
                                            <asp:TableHeaderCell BorderStyle="Solid" BorderWidth="2" BorderColor="Black" Style="vertical-align: Middle">Sil</asp:TableHeaderCell>
                                        </asp:TableHeaderRow>
                                    </asp:Table>
                                    <div class="card-footer">
                                        <asp:LinkButton ID="EkleBtn" CssClass="btn btn-outline-success" runat="server" Text="Ekle" OnClick="EkleBtn_Click"></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3>
                                <asp:Label ID="SilModalBaslikLbl" runat="server" Text="Vasiyet Niteliği Silinecek"></asp:Label>
                            </h3>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:LinkButton ID="NiteligiSilNowBtn" CssClass="btn btn-outline-danger" runat="server" Text="Vasiyet Niteliği Sil" OnClick="NiteligiSilNowBtn_Click"></asp:LinkButton>
        ...
        <div class="modal-content">
            <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="modal-header">
                        <h3>
                            <asp:Label ID="VasiyetNiteligiLbl" runat="server" Text="Vasiyet Niteliği Girişi"></asp:Label>
                        </h3>
                    </div>
                    <div class="modal-body">
                        <div style="display: none">
                        ...
                        <div class="m-1 text-center" id="VasiyetciDiv">
                            <div class="row">
                                <div class="form-group col-4">
                                    <asp:Label CssClass="col-from-label" runat="server" Text="Cinsi"></asp:Label>
                                    <asp:DropDownList ID="VasiyetCinsiDDL" runat="server" CssClass="form-control" Height="34px"></asp:DropDownList>
                                </div>
                                <div class="form-group col-4">
                    ...
                    <div class="modal-footer">
                        <asp:LinkButton ID="NitelikKaydetBtn" CssClass="btn btn-outline-primary" runat="server" Text="Kaydet" OnClick="NitelikKaydetBtn_Click"></asp:LinkButton>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Kapat</button>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>

    ...
    public partial class VasiyetciGirisiWP : WebPart
    {
        ...
        protected void KaydetBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageHelper.PublishMessage("Vasiyetçi Adi Bos Olamaz.", ProjeConstants.MESAJ_HATA, 2000);
                }
                else if (string.IsNullOrEmpty(SoyadiTxt.Text))
                {
                    MessageHelper.PublishMessage("Vasiyetçi Soyadi Bos Olamaz.", ProjeConstants.MESAJ_HATA, 2000);
                }
                else
                {
        ...
        private void VasiyetciyiSilPopupAc(object sender)
        {
            ...
            string openModal = "OpenSilModal();";
            SilMesajiLbl.Text = "Vasiyetçiyi Silmek Istediginizden Emin misiniz?";
        ...
        protected void VasiyetciSilBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (vasiyetci != null)
                {
                    ...
                    {
                        MessageHelper.PublishMessage("Vasiyete konu varlik listesi dolu oldugundan Vasietçi silinemiyor. Lütfen önce Vasiyete Konu Varlik Listesindeki varliklari siliniz", ProjeConstants.MESAJ_HATA);
                    }
                }
            }
            catch (Exception e1)

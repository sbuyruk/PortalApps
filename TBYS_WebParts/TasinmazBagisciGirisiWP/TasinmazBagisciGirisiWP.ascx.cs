    ...
    public partial class TasinmazBagisciGirisiWP : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    //BagisciGirisi açilacak BG
                    OpenBagisciGirisi();
                }
                else if (DestinationAppQS.Equals("TBD"))
                {
                    //BagisciDuzenle açilacak
        ...
        private void OpenBagisciDuzenle(string bagisciId)
        {
            ...
            TitleLbl.Text = "Bagisçi Bilgisi Güncelleme";
        ...
        private void OpenBagisciGirisi()
        {
            ...
            TitleLbl.Text = "Tasinmaz Bagisçisi Girisi";
        ...
        protected void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            if (bagisci != null) //sildikten sonra önceki sayfaya dön
            {
                ...
                {
                    MessageHelper.PublishMessage("Bagisçiya ait talepler, kayitli bagisçi yakinlari, bagisçi ahhütleri veya verilmis armagan oldugundan dolayi bu bagisçi silinemez",ProjeConstants.MESAJ_HATA);
                }
                else
                {
                    bagisci.Delete();
                ...
                MessageHelper.PublishMessage("Hata Bagisçi bulunamadi", ProjeConstants.MESAJ_HATA);
        }
        ...
        protected void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (bagisci != null) //kaydettikten sonra önceki sayfaya dön
                {
                    ...
                    MessageHelper.PublishMessage("Bagisçi Kaydedildi", ProjeConstants.MESAJ_BASARILI, 2000);
                    RedirectToPage(ProjeConstants.PAGE_TASINMAZBAGISCI_LIST + "?Mesaj=true" + "&SecilenId=" + bagisci.Id);

                }
                else
                {
                    MessageHelper.PublishMessage("Bagisçi Kaydedilemedi", ProjeConstants.MESAJ_HATA);
                }
        ...
        protected void UpdateBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (bagisci != null)
                {
                    ...
                    PDFKaydet(bagisci.Id);
                    PDFGoster(bagisci);
                    MessageHelper.PublishMessage("Bagisçi Güncellendi", ProjeConstants.MESAJ_BASARILI, 2000);
                }
                else
                {
                    MessageHelper.PublishMessage("Bagisçi Güncellenemedi", ProjeConstants.MESAJ_HATA);
                }
        ...
        private void PDFKaydet(int bagisciId)
        {
            try
            {
                ...
                else
                {
                    DosyaLnk.Visible = false;
                    BelgeSilBtn.Visible = false;
                    MessageHelper.PublishMessage("Lütfen Bagisçi Bilgi ve Talep Belgesi yükleyiniz.", ProjeConstants.MESAJ_BILGI, 2000);
                }
            ...
            try
            {
                if (bagisci!=null)
                {
                    ...
                    else
                    {
                        ...
                        BelgeSilBtn.Visible = false;
                        BelgeYukleFU.Visible = true;
                        MessageHelper.PublishMessage("Lütfen Bagisçi Bilgi ve Talep Formunu pdf olarak yükleyiniz.", ProjeConstants.MESAJ_BILGI, 2000);
                    }
                    ...
                    else
                    {
                        ...
                        TaahhutSilBtn.Visible = false;
                        TaahhutYukleFU.Visible = true;
                        MessageHelper.PublishMessage("Lütfen Bagisçi Taahhüt Formunu pdf olarak yükleyiniz.", ProjeConstants.MESAJ_BILGI, 2000);
                    }
                }
                else
                {

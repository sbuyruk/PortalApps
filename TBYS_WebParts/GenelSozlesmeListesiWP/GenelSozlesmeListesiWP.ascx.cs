        ...
        private string CreateJsString(string jsonData)
        {
            ...
            string tableString = @"
                ...
                columns: [
                    ...
                    { field: 'SozlesmeTarihi', headerText: 'Söz. Tar.',headerStyle:'width: 8%',bodyClass:'text-right small-font' },
                    { field: 'SozBasTar', headerText: 'Söz. Baş.',headerStyle:'width: 8%', bodyClass:'text-right small-font'}, 
                    { field: 'SozBitTar', headerText: 'Söz. Bit.',headerStyle:'width: 8%', bodyClass:'text-right small-font'},                    
                    { field: 'KiraBedeli', headerText: 'Kira Bedeli',bodyClass:'text-right small-font',headerStyle:'width: 7%' },
                    { field: 'FaizliBakiye', headerText: 'Faizli Bakiye',bodyClass:'text-right small-font',headerStyle:'width: 7%' },
{ field: 'AnaPara', headerText: 'Ana Para',bodyClass:'text-right small-font',headerStyle:'width: 7%' },
{ field: 'FaizTutari', headerText: 'Faiz Tutarı',bodyClass:'text-right small-font',headerStyle:'width: 7%' },
                    { field: 'KiraBorcu', headerText: 'Kira Bor.',bodyClass:'text-right small-font',headerStyle:'width: 4%' },
                    { field: 'TeminatTutari', headerText: 'Tem. Tutarı',bodyClass:'text-right small-font',headerStyle:'width: 7%' },                    
                ],
                datasource:" + jsonData + @",

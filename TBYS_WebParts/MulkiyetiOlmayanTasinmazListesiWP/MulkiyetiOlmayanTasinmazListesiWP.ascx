...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MulkiyetiOlmayanTasinmazListesiWP.ascx.cs" Inherits="TBYS_WebParts.MulkiyetiOlmayanTasinmazListesiWP.MulkiyetiOlmayanTasinmazListesiWP" %>
...
<div class="container ">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-1">
                <asp:Label ID="TitleLbl" runat="server" CssClass="col-form-label text-danger font-weight-bold mb-1" Text="Mülkiyeti Olmayan Taşınmaz Listesi"></asp:Label>

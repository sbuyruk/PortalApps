...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OdemePlaniListesiWP.ascx.cs" Inherits="TBYS_WebParts.OdemePlaniListesiWP.OdemePlaniListesiWP" %>
<script type="text/javascript">
    ...
    var myjsons = [{
        "DosyaNo": "", "KiraciAdi": "", "Adres": "", "OdemeBasBittar": "", "KiraBedeli": "", "OdenenTutar": "", "FaizliBakiye": "", "Duzenle": ""
    }];
...
<div class="container ">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-1">
                <asp:Label ID="TitleLbl" runat="server" CssClass="col-form-label text-danger font-weight-bold mb-1" Text="Ödeme Planı Listesi"></asp:Label>

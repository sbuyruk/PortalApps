...
namespace NBYS_WebParts.NakitBagisciBirlestirmeWP
{
    ...
    public partial class NakitBagisciBirlestirmeWP : WebPart
    {
        ...
        private void BagisciyiBirlestirAtomic()
        {
            ...
            {
                MessageHelper.PublishMessage("Seçtiginiz Asil Bagisçi Bulunamadi.", ProjeConstants.MESAJ_HATA);
                return;
            }
            ...
            foreach (string birlesecekBagisciId in idList)
            {
                ...
                if (bagisciId > 0)
                {
                    ...
                    if (birlesecekBagisci != null)
                    {
                        ...
                        {
                            MessageHelper.PublishMessage("Birlesecek Bagisçi Bulunamadi. Bagisçi=" + birlesecekBagisci.Adi + " #Id: " + birlesecekBagisciId, ProjeConstants.MESAJ_BILGI);
                            continue;
                        }
                        else
                        {
                            try
                            {
                                ...
                                try
                                {
                                    foreach (NakitBagisHareket item in listofBagisHareket)
                                    {
                                        ...
                                        skNBH.SilinenKayitBilgisi = " #BagisciId=" + bagisciIdOnceki + " numarali bagisciya ait " +
                                            ...
                                            item.BagisciId + " numarali bagisçiya birlestirilmistir.";
                                ...
                                try
                                {
                                    ...
                                    //mesaj = string.Format(@"Seçilen Asil Bagisçi={0} ; Birlesecek Bagisçi={1} ; Armaganlar:{2} ",
                                ...
                                if (savedDBOList.Count > 0)
                                {
                                    ...
                                    if (silinecekBagisci != null)
                                    {
                                        ...
                                        skBagisci.SilinenKayitBilgisi = " #Bagisçi=" + silinecekBagisci.Adi + " " + silinecekBagisci.Soyadi + " #BagisciId=" + silinecekBagisci.Id + " numarali bagisçi silindi.";
                                    }

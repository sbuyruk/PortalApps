...
<div class="container ">
    <div class="card shadow">
        <div class="card-header ">
            ...
            <h3 class="mb-1">
                <asp:Label CssClass="col-form-label text-info fw-bold mb-1" ID="TitleLbl" runat="server" Text="Bölgelere Göre Armağan Raporu"></asp:Label>
        ...
        <div class="row m-2">
            <!-- Başlangıç Ay -->
            <div class="col-2">
                <label for="BasAyDDL" class="form-label fw-semibold">Başlangıç Ay</label>
                <asp:DropDownList ID="BasAyDDL" runat="server" CssClass="form-select form-select-lg "
                    OnSelectedIndexChanged="BasAyDDL_SelectedIndexChanged" AutoPostBack="true">
                </asp:DropDownList>
            </div>

            <!-- Başlangıç Yıl -->
            <div class="col-2">
                <label for="BasYilDDL" class="form-label fw-semibold">Yıl</label>
                <asp:DropDownList ID="BasYilDDL" runat="server" CssClass="form-select form-select-lg "
                    OnSelectedIndexChanged="BasAyDDL_SelectedIndexChanged" AutoPostBack="true">
                </asp:DropDownList>
            </div>
            ...
            <!-- Bitiş Ay -->
            <div class="col-2">
                <label for="BitAyDDL" class="form-label fw-semibold">Bitiş Ay</label>
                <asp:DropDownList ID="BitAyDDL" runat="server" CssClass="form-select form-select-lg "
                    OnSelectedIndexChanged="BasAyDDL_SelectedIndexChanged" AutoPostBack="true">
                </asp:DropDownList>
            </div>
            ...
            <!-- Bitiş Yıl -->
            <div class="col-2">
                <label for="BitYilDDL" class="form-label fw-semibold">Yıl</label>
                <asp:DropDownList ID="BitYilDDL" runat="server" CssClass="form-select form-select-lg "
                    OnSelectedIndexChanged="BasAyDDL_SelectedIndexChanged" AutoPostBack="true">
                </asp:DropDownList>
            </div>
        </div>
                ...
                <div class="card-body">
                    <asp:Table ID="NBTable" runat="server" class="loader table table-bordered table-hover table-striped">
                        <asp:TableHeaderRow HorizontalAlign="Center">
                            <asp:TableCell ID="TableHeaderCell" runat="server" CssClass="btn-light fw-bold" Style="border: 1px solid black;" ColumnSpan="6"></asp:TableCell>
                        </asp:TableHeaderRow>
                        <asp:TableHeaderRow HorizontalAlign="Center">
                            <asp:TableCell CssClass="btn-light fw-bold" Style="border: 1px solid black;">Bölge</asp:TableCell>
                            <asp:TableCell CssClass="btn-light fw-bold" Style="border: 1px solid black;">Altın Madalya</asp:TableCell>
                            <asp:TableCell CssClass="btn-light fw-bold" Style="border: 1px solid black;">Gümüş Madalya</asp:TableCell>
                            <asp:TableCell CssClass="btn-light fw-bold" Style="border: 1px solid black;">Bronz Madalya</asp:TableCell>
                            <asp:TableCell CssClass="btn-light fw-bold" Style="border: 1px solid black;">Teşekkür Belgesi</asp:TableCell>
                            <asp:TableCell CssClass="btn-light fw-bold" Style="border: 1px solid black;">Bölge Toplam</asp:TableCell>
                        </asp:TableHeaderRow>
                        <asp:TableRow HorizontalAlign="Center">
                            <asp:TableCell ID="AnkBaslikCell" CssClass="fw-bold" Style="border: 1px solid black;">Ankara Bölge</asp:TableCell>
                            ...
                            <asp:TableCell ID="AnkAdetTopCell" CssClass="fw-bold" Style="border: 1px solid black;"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow HorizontalAlign="Center">
                            <asp:TableCell ID="IstBaslikCell" CssClass="fw-bold" Style="border: 1px solid black;">İstanbul Bölge</asp:TableCell>
                            ...
                            <asp:TableCell ID="IstAdetTopCell" CssClass="fw-bold" Style="border: 1px solid black;"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow HorizontalAlign="Center">
                            <asp:TableCell ID="IzmBaslikCell" CssClass="fw-bold" Style="border: 1px solid black;">İzmir Bölge</asp:TableCell>
                            ...
                            <asp:TableCell ID="IzmAdetTopCell" CssClass="fw-bold" Style="border: 1px solid black;"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow HorizontalAlign="Center">
                            <asp:TableCell ID="MerBaslikCell" CssClass="fw-bold" Style="border: 1px solid black;">Mersin Bölge</asp:TableCell>
                        ...
                        <asp:TableRow HorizontalAlign="Center">
                            ...
                            <asp:TableCell ID="YurtDisiAdetTopCell" CssClass="fw-bold" Style="border: 1px solid black;"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow HorizontalAlign="Center">
                            <asp:TableCell ID="TopBaslikCell" CssClass="fw-bold" Style="border: 1px solid black;">Toplam</asp:TableCell>
                            <asp:TableCell ID="AltinAdetToplamCell" CssClass="fw-bold" Style="border: 1px solid black;" runat="server" ></asp:TableCell>
                            <asp:TableCell ID="GumusAdetToplamCell" CssClass="fw-bold" Style="border: 1px solid black;" runat="server" ></asp:TableCell>
                            <asp:TableCell ID="BronzAdetToplamCell" CssClass="fw-bold" Style="border: 1px solid black;" runat="server" ></asp:TableCell>
                            <asp:TableCell ID="TesAdetToplamCell" CssClass="fw-bold" Style="border: 1px solid black;" runat="server" ></asp:TableCell>
                            <asp:TableCell ID="TopAdetTopCell" CssClass="fw-bold text-danger" Style="border: 1px solid black;"></asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                    <div>

...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FTKKuruluOlmayanIlIlceListesiWP.ascx.cs" Inherits="NBYS_WebParts.FTKKuruluOlmayanIlIlceListesiWP.FTKKuruluOlmayanIlIlceListesiWP" %>
<style>

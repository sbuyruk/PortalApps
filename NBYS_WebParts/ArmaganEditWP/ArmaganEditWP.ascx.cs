            ...
            try
            {
                ...
                if (armagan != null)
                {
                    ...
                    else
                    {
                        ...
                        MessageHelper.PublishMessage("Armagan, Bölgenizdeki bir bagisçiya ait degil.", ProjeConstants.MESAJ_HATA);
                    }
                }
                else
                {
        ...
        protected void KaydetBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isSaved)
                {
                    ...
                    MessageHelper.PublishMessage("Armagan Kaydi Güncellendi", ProjeConstants.MESAJ_BASARILI, 2000);
                }
                else
                {

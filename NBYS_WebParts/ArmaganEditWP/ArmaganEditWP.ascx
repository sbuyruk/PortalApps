        ...
        <ContentTemplate>
            <div class="card shadow">
                <div class="card-header" id="CardHeader" runat="server">
                    ...
                    <h3 class="mb-2">
                        <asp:Label CssClass="col-form-label text-info font-weight-bold mb-1" ID="TitleLbl" runat="server" Text="Armağan Kaydı Düzenleme"></asp:Label>
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <div class="form-group m-0 ">
                                    ...
                                    <asp:TextBox ID="BagisMiktariTxt" runat="server" class="form-control input-money text-right" type="text" />
                                </div>
                            </div>
                            <div class="form-group col">
                                <div class="form-group m-0 ">

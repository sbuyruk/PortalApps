    ...
    public partial class TasinmazArmaganListesiWP : WebPart
    {
        ...
        private List<TasinmazBagisciListItem> GetDataList()
        {
            ...
            foreach (DataRowView row in dataView)
            {
                ...
                bagisciItem.BagisciKarti = "<a target='_blank' href=" + ProjeConstants.PAGE_TASINMAZBAGISCI_KARTI + "?SenderApp=TBL&BagisciId=" + tasinmazBagisciId + " class='btn btn-outline-info'>Tasinmaz Bagisçi Karti</a>";

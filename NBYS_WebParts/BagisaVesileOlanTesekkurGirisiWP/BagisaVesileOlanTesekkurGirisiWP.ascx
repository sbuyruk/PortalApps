            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <asp:LinkButton ID="KaydetBtn" runat="server" CssClass="btn btn-success" OnClick="KaydetBtn_Click">Kaydet</asp:LinkButton>
                        <asp:LinkButton ID="GuncelleBtn" runat="server" CssClass="btn btn-primary" OnClick="GuncelleBtn_Click">Güncelle</asp:LinkButton>
                        <asp:LinkButton ID="DosyaOlusturBtn" runat="server" CssClass="btn btn-info" OnClick="DosyaOlusturBtn_Click">Teşekkür Belgesini Oluştur</asp:LinkButton>
                        <asp:LinkButton ID="ListeyeGitBtn" runat="server" CssClass="btn btn-secondary float-end" OnClick="ListeyeGitBtn_Click">Bağışa Vesile Olanlar Listesi</asp:LinkButton>

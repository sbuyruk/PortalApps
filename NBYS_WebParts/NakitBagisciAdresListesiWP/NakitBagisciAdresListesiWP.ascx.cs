        ...
        protected void DergiGondermeBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (nb != null)
                {
                    ...
                    if (nb.Update())
                    {
                        MessageHelper.PublishMessage(nb.Adi + " Adli bagisçiya dergi gönderilmeyecek.", ProjeConstants.MESAJ_BASARILI, 2000);
                    ...
                    {
                        MessageHelper.PublishMessage(" Bagisçi bilgisi degistirilemedi.", ProjeConstants.MESAJ_HATA);
                    }
                }
                else
                {
            ...
            catch (Exception ex)
            {
                ...
                exh.Exceptions.Add(new Exception("Dergi Gönderme durumu degistirilemedi. "));

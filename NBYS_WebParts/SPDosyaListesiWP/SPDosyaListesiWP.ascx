...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SPDosyaListesiWP.ascx.cs" Inherits="NBYS_WebParts.SPDosyaListesiWP.SPDosyaListesiWP" %>
<script>
...
<div class="container">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-danger fw-bold mb-1" ID="TitleLbl" runat="server" Text="Kira Borcu İhbarname Yazıları"></asp:Label>

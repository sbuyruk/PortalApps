...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FTKKisiListesiWP.ascx.cs" Inherits="NBYS_WebParts.FTKKisiListesiWP.FTKKisiListesiWP" %>
<style>
...
<script type="text/javascript">
    ...
    var myjsons = [{
        "Sirano": "", "AdiSoyadi": "",  "FTKGorevi": "", "Unvani": "", "Telefon1": "", "Ili": "", "Ilcesi": "", "Duzenle": ""
    }];
    jQuery(document).ready(function () {
        ...
        jQuery('#CustomDataTable').DataTable({
            ...
            columnDefs: [
                { type: 'turkish', targets: [1, 2, 3, 5, 6] }
            ],
            'order': [[5, 'asc'], [6, 'asc']],//İl,İlçe Sıralı
            "language": {
...
<div class="container">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-1">
                <asp:Label ID="TitleLbl" runat="server" CssClass="col-form-label text-danger font-weight-bold mb-1" Text="FTK Kişi Listesi"></asp:Label>

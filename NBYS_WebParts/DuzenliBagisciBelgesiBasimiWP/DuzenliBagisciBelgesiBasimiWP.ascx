...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DuzenliBagisciBelgesiBasimiWP.ascx.cs" Inherits="NBYS_WebParts.DuzenliBagisciBelgesiBasimiWP.DuzenliBagisciBelgesiBasimiWP" %>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <h3 class="mb-2">
                        ...
                        <asp:Label CssClass="col-form-label text-danger fw-bold mb-1" ID="TitleLbl" runat="server" Text="Düzenli Bağşçı Belgesi Oluşturma"></asp:Label>
                    </h3>
                </div>
                <div class="card-body">
                    <div class="form-group row p-2">
                        ...
                        <div class="form-group col-4 border border-dark  border-right-0">
                            <div class="form-group ">
                                <asp:Table ID="BelgeTable" runat="server" class="table table-bordered table-striped">
                                </asp:Table>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <asp:HyperLink ID="DosyaLnk" runat="server" CssClass="btn-link m-3" Visible="false">Düzenli Bağışçı Belgeleri</asp:HyperLink>
                    <asp:HyperLink ID="AdresEtiketLnk" runat="server" CssClass="btn-link m-3" Visible="false">Adres Etiketleri</asp:HyperLink>
                </div>

                <div class="card-footer">
                    <asp:CheckBox ID="DurumChk" runat="server" Checked="false" Text=" -Gönderildi- yap" />
                    <asp:LinkButton ID="DosyaOlusturBtn" runat="server" CssClass="btn btn-outline-success" OnClick="DosyaOlusturBtn_Click">Düzenli Bağışçı Belgelerini Oluştur</asp:LinkButton>

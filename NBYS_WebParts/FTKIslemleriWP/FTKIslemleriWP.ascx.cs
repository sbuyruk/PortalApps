    ...
    public partial class FTKIslemleriWP : WebPart
    {
        ...
        private void FTKIslemleriFormunuDoldur()
        {
            ...
            else
            {
                ...
                TitleLbl.Text = "FTK Islemleri Düzenle";
        ...
        private string ValiDoldur(int ili)
        {
            ...
            {
                MessageHelper.PublishMessage("Önce Il seçiniz", ProjeConstants.MESAJ_BILGI, 2000);
            }
        ...
        {
            /***
             * 1 Seçilen il ve seçilen ilçe için FTKIslem_Table'da kayit var mi
             *  Varsa
             *      2 Güncelleme yap
             *  Yoksa 
             *      3 kaydet 
            ...
            {
                MessageHelper.PublishMessage("Bu FTK " + FTKGuncellemeTarihiTxt.Text + " tarihinde zaten güncellenmistir. FTK listesinde kayit düzeltmek istiyorsaniz, 'Bu Bir Kayit Düzeltmesidir' hanesini seçili hale getiriniz.", ProjeConstants.MESAJ_HATA);
            }
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (guncellendiMi)
                        {
                            ...
                            {
                                DuzenleAc();
                                MessageHelper.PublishMessage("FTK Islemi güncellendi.", ProjeConstants.MESAJ_BASARILI, 2000);
                            }
                        }
                    }
        ...
        private bool FTKTablosunaKaydetveyaGuncelle(FTKIslem ftkIslem)
        {
            ...
            if (KayitDuzeltmesiChk.Checked)
            {
                ...
                if (list.Count < 1)
                {
                    MessageHelper.PublishMessage("Düzeltmesi yapilacak bir FTK kaydi bulunamadi.", ProjeConstants.MESAJ_HATA);
                }
                else
                {
                    FTK ftk = list[0];
        ...
        private bool FTKTablosunaKaydet(FTKIslem ftkIslem, int sayac)
        {
            ...
            if (sayac > 0)
            {
                aciklama = DateTime.Now.ConvertToTimeSpanReturnInHHmm() + " tarihinde " + UtilityHelper.GetCurrentUserLoginName() + " tarafindan kayit düzeltmesi yapildi.";
            }
        ...
        protected void TumununGoreviniSonlandirNowBtn_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(idler))
            {
                ...
                {
                    FTKListesiniVeriTabanindanDoldur();
                    MessageHelper.PublishMessage("Üyelerin görevleri sonlandirildi.", ProjeConstants.MESAJ_BASARILI, 2000);
                }
                else
                {
                    MessageHelper.PublishMessage("Üyelerin görevleri sonlandirilamadi.", ProjeConstants.MESAJ_HATA);
                }
            }
        }
        ...
        protected void UyelerinGoreviniSonlandirBtn_Click(object sender, EventArgs e)
        {
            ...
            ModalFTKListesiBaslikLbl.Text = "Üyelerin Görevi Sonlandirilacak";
            ModalTabloOlustur(true);
            UtilityHelper.ScriptCalistir("ModalFTKListesiAc()");
        }
    }

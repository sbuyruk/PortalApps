...
<div class="container">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-danger font-weight-bold mb-1" ID="TitleLbl" runat="server" Text="NBYS Parametreleri"></asp:Label>
        ...
        <div class="card-body">
            <div class="form-group col-3">
                <asp:DropDownList ID="GrupDDL" CssClass="form-control" runat="server" Height="34px" OnSelectedIndexChanged="GrupDDL_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
            </div>
            <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <div Id="VeriGirisiDiv" runat="server" style="display:none">
                        <div class="form-group row">
                            ...
                            <div class="form-group col-3">
                                <asp:Label ID="Label5" CssClass="col-form-label" runat="server" Text="Anahtar"></asp:Label>
                                <asp:TextBox ID="YeniAnahtarTxt" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="form-group col-3">
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="GrupDDL" EventName="SelectedIndexChanged" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="DuzenleDiv" runat="server" style="display: none">
                                    <div class="form-group col">
                                        <asp:Label CssClass="col-form-label" runat="server" Text="Parametre"></asp:Label>
                                        <asp:TextBox ID="AnahtarTxt" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="form-group col">
                                        <asp:Label CssClass="col-form-label" runat="server" Text="Değer"></asp:Label>
                                        <asp:TextBox ID="DegerTxt" runat="server" CssClass="form-control "></asp:TextBox>
                                    </div>

...
<div class="container shadow">
    <div class="card ">
        <div class="card-header" id="CardHeader" runat="server">
            ...
            <h3 class="mb-2">
                <asp:Label CssClass="col-form-label text-info font-weight-bold mb-1" ID="TitleLbl" runat="server" Text="Bağış Listesi (Bağış Hareketleri)"></asp:Label>
            ...
            <ContentTemplate>
                ...
                <div class="card-body mt-1">
                    <div class="row">
                        ...
                        <div class="form-group col">
                            <label for="YilDDL" class="col-form-label text-right">Yıl</label>
                        ...
                        <div class="form-group col">
                            <label for="IlilDDL" class="col-form-label text-right">İl</label>

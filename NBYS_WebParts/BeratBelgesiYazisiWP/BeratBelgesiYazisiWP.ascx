...
<div class="container ">
            ...
            <div class="card shadow">
                <div class="card-header">
                    ...
                    <h3 class="mb-2">
                        <asp:Label CssClass="col-form-label text-danger font-weight-bold mb-1" ID="TitleLbl" runat="server" Text="Berat Belgesi Oluşturma"></asp:Label>
                        ...
                        <div class="form-group col-4 border border-dark border-right-0">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <asp:DropDownList ID="MadalyaDDL" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="MadalyaDDL_SelectedIndexChanged" Style="height: auto" />
                                </div>
                            </div>
                        </div>

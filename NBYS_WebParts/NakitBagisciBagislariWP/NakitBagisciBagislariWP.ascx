...
<div class="container shadow">
    <asp:UpdatePanel ID="upPanel" runat="server">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-header">
                    <asp:Label ID="AdiLbl" runat="server" Text=""></asp:Label>
                </div>
                <div class="card-body">
                    <div style="display: none">
                ...
                <div class="card-footer">
                    <asp:LinkButton CssClass="btn btn-outline-success float-right" ID="ExcelBtn" ClientIDMode="Static" runat="server" Text="Excele Aktar" OnClick="ExcelBtn_Click" OnClientClick="javascript:setFormSubmitToFalse()" Visible="False" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>

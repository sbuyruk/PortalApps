...
namespace NBYS_WebParts.NakitBagisciEditWP {
    ...
    public partial class NakitBagisciEditWP {
        ...
        private global::System.Web.UI.WebControls.Label @__BuildControlTitleLbl() {
            ...
            @__ctrl.ID = "TitleLbl";
            @__ctrl.Text = "Bagisçi Bilgileri Degistirme";
            return @__ctrl;
        }
        ...
        <div class=""card-group mt-1 text-end"">
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl(@"
                ...
                <div class=""form-group row "">
                    <label class=""col-4 col-form-label form-control-label"">Ulasilamiyor</label>
                    <div class=""col-8"">
                        "));
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl(@"
                ...
                <div class=""form-group row "">
                    <label class=""col-4 col-form-label form-control-label"">Belge Istemiyor</label>
                    <div class=""col-8"">
                        "));
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl(@"
                ...
                <div class=""form-group row "">
                    <label class=""col-4 col-form-label form-control-label"">Sag mi</label>
                    <div class=""col-8"">
                        "));
            ...
            <div class=""col-6 mt-1"">
                <div class=""form-group row "">
                    <label class=""col-4 col-form-label form-control-label"">Il</label>
                    <div class=""col-8"">
                        "));
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl(@"
                ...
                <div class=""form-group row "">
                    <label class=""col-4 col-form-label form-control-label"">Tüzel Kisi</label>
                    <div class=""col-8"">
                        "));
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl(@"
                ...
                <div class=""form-group row mb-1"">
                    <label class=""col-4 col-form-label form-control-label"">Açiklama</label>
                    <div class=""col-8"">
                        "));

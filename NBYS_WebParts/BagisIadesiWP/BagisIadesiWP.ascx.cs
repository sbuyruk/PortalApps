    ...
    public partial class BagisIadesiWP : WebPart
    {
                ...
                foreach (DataRowView row in dataView)
                {
                    ...
                    else
                    {
                        ...
                        if (isLinkVisible)
                            ...
                            iadeLink = "<span class=bagis-iade-edilemez>Iade süresi dolmus</span>";
                    }
        ...
        protected void BagisiIadeEtBtn_Click(object sender, EventArgs e)
        {
            ...
            if (nbh != null)//bu bagis varsa
            {
                ...
                {
                    MessageHelper.PublishMessage("Iade süresi dolmus. Para iadesi yapilamaz.", ProjeConstants.MESAJ_HATA);
                }
            }
            else
            {
                ...
                IadeMesajiLbl.Text = " Seçilen bagis bilgilerine ulasilamadi";
                ...
                if (nbh != null)
                {
                    ...
                    if (nb != null)
                    {
                        ...
                        if (armagan != null && armagan.Durum.Equals(ProjeConstants.DURUM_GONDERILMEDI))//armagan varsa ve durumu gönderilmedi ise 
                        {
                            ...
                            armagan.ArmaganBagisMiktari = armagan.BagisMiktari; //bagis iadesi öncesi armagana hak kazandigi tutar
                            ...
                            armagan.Aciklama = armagan.Aciklama + nb.Adi + " adli bagisçiya ait bagis iade edilmistir. ";
                    ...
                    {
                        MessageHelper.PublishMessage(" Bagisçi bulunamadi. Para Iadesi Yapilamadi. ", ProjeConstants.MESAJ_HATA);
                        TabloOlustur();
                    }
                }
                else
        ...
        protected void IadeDegistirBtn_Click(object sender, EventArgs e)
        {
            ...
            if (nbh != null)//bu bagis varsa
            {
                ...
                OnayMesajiDegistirLbl.Text = bagisciAdi + " tarafindan yapilan bagisin iade sebebi ve iade tarihini güncelleyebilirsiniz.";
            ...
            else
            {
                ...
                IadeMesajiDegistirLbl.Text = " Seçilen bagis bilgilerine ulasilamadi";
        ...
        protected void IadeDegistirNowBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (nbh != null)
                {
                    ...
                    if (nb != null)
                    {
                        ...
                        nbh.Aciklama += " Iade tarhi ve sebebi güncellenmistir.";
                    ...
                    {
                        MessageHelper.PublishMessage(" Bagisçi bulunamadi. Para Iadesi Güncellenemedi. ", ProjeConstants.MESAJ_HATA);
                        TabloOlustur();
                    }
                }
                else
                {
                    MessageHelper.PublishMessage("Bagis kaydi bulunamadi. Para Iadesi Güncellenemedi.", ProjeConstants.MESAJ_HATA);
                    TabloOlustur();
                }
            ...
            {
                ExceptionHelper exh = new ExceptionHelper();
                exh.Exceptions.Add(new Exception("Iade güncellenirken hata olustu. "));
                exh.Exceptions.Add(ex);
                exh.PublishException();
            }
        }

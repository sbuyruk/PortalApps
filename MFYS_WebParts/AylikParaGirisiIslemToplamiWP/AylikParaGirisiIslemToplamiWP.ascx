...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AylikParaGirisiIslemToplamiWP.ascx.cs" Inherits="MFYS_WebParts.AylikParaGirisiIslemToplamiWP.AylikParaGirisiIslemToplamiWP" %>

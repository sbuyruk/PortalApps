...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BankaBazindaGunlukBagisListesiWP.ascx.cs" Inherits="MFYS_WebParts.BankaBazindaGunlukBagisListesiWP.BankaBazindaGunlukBagisListesiWP" %>
<style>
...
<div class="container w-50">
    <div class="card shadow">
        <div class="card-header">
            ...
            <h3 class="mb-1">
                <asp:Label ID="TitleLbl" runat="server" CssClass="col-form-label text-primary fw-bold mb-1" Text="Banka Bazında Günlük TL Bağışlar"></asp:Label>
